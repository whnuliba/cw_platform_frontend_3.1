{
 ...
 url:{
    deleteUri:'/cw-pms-app/pms-soft-bug/deleteById',
    editUri:'/cw-pms-app/pms-soft-bug/updateById',  
    addUri:'/cw-pms-app/pms-soft-bug/createBaseComponent',  
    queryUri:'/cw-pms-app/pms-soft-bug/queryPage', 
    batchAddUri:'/cw-pms-app/pms-soft-bug/batchCreateBaseComponent',
    fileUpload:'/cw-pms-app/pms-soft-bug/uploadFile',
    fileDownload:'/cw-pms-app/pms-soft-bug/downloadFile',
    removeFile:'/cw-pms-app/pms-soft-bug/removeFile',      
 },  
 customToolBar:{
           show:true,
           showFilter:true,
 ...
 formModes:[
   {
      ...
      buttons:[
            {text:'确认',hideText:false,icon:'el-icon-success',permCode:undefined,background:'',size:'max',callback:function(e,row,form){
                      ...
                      let op = {url:'/cw-pms-app/pms-soft-bug/complete',params:fa}
                              ...
                              {text:'指派',icon:'el-icon-right',background:'',size:'mini',
                               ...
                               ,callback: function(e,self,row,selected){ 
									  ...
									  type: 'warning'
										   ...
										   let op = {url:'/cw-pms-app/pms-soft-bug/assign',params:{data:row.ID}}
										   this.actionPost(op).then((data)=>{
												   self.$message({
													type: 'success',
                               ...
                               ,callback: function(e,self,row,selected){ 
							           this.$confirm(this.i18n("开始后必须在指定时间完成，否则会影响你的KPI"), this.i18n("common.tip_info.tips"), {
										  ...
										  type: 'warning'
										   ...
										   let op = {url:'/cw-pms-app/pms-soft-bug/startTask',params:{data:row}}
										   this.actionPost(op).then((data)=>{
												   self.$message({
													type: 'success',
													message: 'change success!=>' + data
