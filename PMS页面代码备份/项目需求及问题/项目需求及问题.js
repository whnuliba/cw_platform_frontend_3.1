{
 ...
 url:{
    deleteUri:'/cw-pms-app/pms_pro_demand/deleteById',
    editUri:'/cw-pms-app/pms_pro_demand/updateById',  
    addUri:'/cw-pms-app/pms_pro_demand/createBaseComponent',  
    queryUri:'/cw-pms-app/pms_pro_demand/queryPage', 
    batchAddUri:'/cw-pms-app/pms_pro_demand/batchCreateBaseComponent',
    fileUpload:'/cw-pms-app/pms_pro_demand/uploadFile',
    fileDownload:'/cw-pms-app/pms_pro_demand/downloadFile',
    removeFile:'/cw-pms-app/pms_pro_demand/removeFile',      
 },  
 customToolBar:{
           show:true,
           showFilter:true,
 ...
 formModes:[
   {
      ...
      buttons:[
            {text:'确认',hideText:false,icon:'el-icon-success',permCode:undefined,background:'',size:'max',callback:function(e,row,form){
                      ...
                      let op = {url:'/cw-pms-app/pms_pro_demand/complete',params:fa}
 ...
 cols: [
       ...
       queryType: 'select',selUri:'/cw-pms-app/app/constant/work-task-states',TASK_STATE:['name','value'], set: false, require: true, query: true, hide: false },
            ...
            { field: 'ATTACHMENT3', title: '附件3', minWidth: 100, align: "center", queryType: 'file', set: false, require: false, query: false, hide: true },
      		{ field: 'DESCRIPTION', title: '问题描述', minWidth: 100, align: "center", queryType: 'textarea',style:{width:'600px'}, set: true, require: false, query: false, hide: false },
                              ...
                              {text:'指派',icon:'el-icon-right',background:'',size:'mini',
                               ...
                               ,callback: function(e,self,row,selected){ 
									  ...
									  type: 'warning'
										   ...
										   let op = {url:'/cw-pms-app/pms_pro_demand/assign',params:{data:row.ID}}
										   this.actionPost(op).then((data)=>{
												   self.$message({
													type: 'success',
                               ...
                               ,callback: function(e,self,row,selected){ 
							           this.$confirm(this.i18n("开始后必须在指定时间完成，否则会影响你的KPI"), this.i18n("common.tip_info.tips"), {
										  ...
										  type: 'warning'
										   ...
										   let op = {url:'/cw-pms-app/pms_pro_demand/startTask',params:{data:row}}
										   this.actionPost(op).then((data)=>{
												   self.$message({
													type: 'success',
													message: 'change success!=>' + data
