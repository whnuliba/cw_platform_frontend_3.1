    ...
    formModes: [
        {
            ...
            forms: [
                ...
                { field: 'endCCCVCapacityStep', title: '结束充电容量选择步次', en_title: 'End Charge Capacity Selection Step', boxWidth: '150px', align: "center", queryType: 'input', set: true, require: false, query: false, hide: false },
