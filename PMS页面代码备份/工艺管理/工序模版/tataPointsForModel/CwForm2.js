    ...
    formModes: [
        {
            ...
            forms: [
                ...
                { field: 'compensationCapacityUpperLimit', title: '补偿容量上限', title: '补偿容量上限', en_title: 'Compensation capacity upper limit', boxWidth: '150px', minWidth: 100, align: "center", queryType: 'input', set: true, require: false, query: false, hide: false },
