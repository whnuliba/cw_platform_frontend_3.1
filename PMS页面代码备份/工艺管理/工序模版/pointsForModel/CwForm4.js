    ...
    formModes: [
        {
            ...
            forms: [
                ...
                { field: 'isEnable', title: '是否开启初始电压', en_title: 'Enable Initial Voltage', boxWidth: '150px', align: 'center', queryType: 'switch', set: true, require: false, query: false, hide: false },
