            ...
            >
              ...
              <el-col :span="12">
                <el-form-item label="曲线采样时间(s)">
                  ...
                  <!-- <el-date-picker
                    v-model="processContent.pp.collectTime"
      ...
      nowAdd() {
        ...
        for(let k in this.processContent.pp) {
          ...
          || k=='globalNGLimit'|| k=='t5CurrentUp' || k=='t1TimeUp' || k=='isEnable' || k=='chargeCheckVolt8'|| k=='isEndEnable' || k=='collectTime'
            //  || k=='setStep' || k=='VoltageType' || k=='V0' || k=='V1' || k=='I'
             ) 
            {
              this.processContent.pp[k] =  this.processContent.pp[k] ? parseInt(this.processContent.pp[k]) : this.processContent.pp[k]
            } 
            
            // if(k == 'K1' || k == 'K2' || k == 'K3' || k == 'K4' || k == 'B' || k == 'capacityDivision1Low' || k == 'capacityDivision1Up' || k == 'capacityDivision2Low' || k == 'capacityDivision2Up'
            //  ) {
