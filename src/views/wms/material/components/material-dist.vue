  ...
  <div class="filter-container">
    ...
    <el-dialog :title="$t('common.btn.edit')" v-el-drag-dialog :visible.sync="dialogFormVisible" width="700px" >
      ...
      <el-form ref="decomData" :inline="true" :model="decomData" label-width="120px" size="mini">
           ...
           <el-form-item label='产品代码'  label-width="90px"
            :rules="[{ required: true, message: '料号不能为空', trigger: 'blur' }]" >
             <el-input  v-model="decomData.pn" style="width:180px;" />
          </el-form-item>
          <el-form-item label='图号'  label-width="90px"
            :rules="[{ required: true, message: '图号不能为空', trigger: 'blur' }]" >
             <el-input  v-model="decomData.gn" style="width:180px;" />
          </el-form-item>
         <el-form-item label='数量'  label-width="90px"
            :rules="[{ required: true, message: '数量不能为空', trigger: 'blur' }]" >
             <el-input  v-model.number="decomData.poQty" style="width:180px;" />
          </el-form-item>
          <el-form-item  label="交货时间"  label-width="90px" >
              <el-date-picker format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss"   v-model="decomData.endTime"  type="datetime"    style="width: 180px"> </el-date-picker>
          </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer" >
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/materialDist/add",
          del:"/materialDist/del",
          list:"/materialDist/guest/query"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [     
            { field: 'orderNo', title: '物料单号',en_title:"PN",  align: "left",query:true,queryType:'input',editReadonly:false,set:false,require:true },             
            { field: 'extOrderNo', title: '生产单号',en_title:"PN",  align: "left",query:true,queryType:'input',editReadonly:false,set:false,require:true },                     
            ...
            { field: 'createUser', title: '创建人',hide:true, align: "left",query:false,queryType:'input',set:false,require:true },
            { field: 'planNo', title: '计划号', align: "left",query:true,queryType:'select',set:true,require:true },
            { field: 'wsNo', title: '工厂编码', align: "left",query:true,queryType:'input',set:true,require:true },
            { field: 'scNo', title: '产线编码', align: "left",query:false,queryType:'datetime',set:true,require:true },
            { field: 'lotNo', title: '批次', align: "left",hide:true,query:false,queryType:'input',set:true,require:true },
            { field: 'status', title: '状态', align: "left",query:false,queryType:'input',set:true,require:true },          
      ]
    }
  ...
  methods: {
       materialDistRowClick(row, column, event){
             this.$emit('changeMaterialDistId',  row)
       },
         initData(arr){
       let args = {}
          arr.map(c=>{
