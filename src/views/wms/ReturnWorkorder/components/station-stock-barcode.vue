 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/return-material-sn/add",
          del:"/return-material-sn/del",
          list:"/return-material-sn/guest/item"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [       
            ...
            { field: 'minQty', title: '备料数量', align: "left",query:false,queryType:'input',set:false,require:true,edit:true   },
