<template>
  ...
  <div class="filter-container">
          <div  v-for="(item,index) in cols" :key="index" style="display:inline">
                  <el-input  v-if="item.query && item.queryType==='input'" v-model="queryParams.requestData[item.field]" :placeholder="commonI18n(item)" style="width: 145px" class="filter-item">
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/return-material-item/add",
          del:"/return-material-item/del",
          list:"/return-material-item/guest/query"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [     
            { field: 'processNo', title: '工序编码', align: "left",query:true,queryType:'input',set:true,require:true },       
