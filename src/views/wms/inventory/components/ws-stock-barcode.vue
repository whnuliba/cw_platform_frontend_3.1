  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/ws-material/add",
          del:"/ws-material/del",
          list:"/ws-material/guest/barcode"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [       
            ...
            { field: 'packQty', title: '包装数量', align: "left",query:false,queryType:'input',set:false,require:true   },
            { field: 'deliveryTime', title: '到库时间', align: "left",query:false,queryType:'datetime',set:false,require:true   },
