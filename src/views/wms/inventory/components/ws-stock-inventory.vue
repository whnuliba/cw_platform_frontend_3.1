  ...
  data() {
    const  _initdata ={
      ...
      cols: [     
            ...
            { field: 'stockAreaNo', title: '备料区编码',en_title:"PN",  align: "left",query:true,queryType:'input',editReadonly:false,set:false,require:true },                     
            { field: 'stockAreaName', title: '备料区名称', align: "left",query:true,queryType:'input',set:true,require:true },
            { field: 'admin', title: '管理员', align: "left",query:true,queryType:'input',set:false,require:true },
            { field: 'projectNo', title: '费用号', align: "left",query:true,queryType:'input',set:true,require:true },
            { field: 'erpOrderNo', title: '订单号', align: "left",query:true,queryType:'input',set:false,require:true },
            { field: 'pn', title: '产线编码', align: "left",query:true,queryType:'input',set:true,require:true },
            ...
            { field: 'lotNo', title: '批次', align: "left",hide:true,query:true,queryType:'input',set:true,require:true },
            { field: 'inventory', title: '库存', align: "left",query:false,queryType:'input',set:true,require:true },
            { field: 'useQty', title: '已用库存', align: "left",query:false,queryType:'input',set:true,require:true },
            { field: 'lockQty', title: '锁定库存', align: "left",query:false,queryType:'input',set:true,require:true },              
