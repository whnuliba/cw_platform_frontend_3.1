  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          { field: 'stockAreaName', title: '备料区名称', minWidth: 100, align: "center",queryType: 'input', set: true, query: true, },
          { field: 'stockAreaNo', title: '备料区编号', minWidth: 100, align: "center", queryType: 'input', set: true, query: true,},
          { field: 'wsNo', title: '车间编号', minWidth: 100, align: "center", query: true, queryType: 'selectforce', set: true, },
          // { field: 'wsId', title: '车间ID', minWidth: 100, align: "center", queryType: 'input', set: true,disabled:true,hide:true },
          { field: 'admin', title: '管理员', minWidth: 100, align: "center", queryType: 'input', set: true },
    ...
    methods: {
      forceUpdate(v){
       ...
       getpnData(){
        let _data = {url:'/workshop/guest/getall',params:{}}
      ...
      getList() {
        ...
        const _data = { url: '/ws-material/list', params: this.queryParams }
      ...
      save(formName) {
        ...
        let _data = { url: '/ws-material/add', params: { data: this.defaultForm.params } }
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$store.dispatch('fmsCommon/actionWmsPost', _data)
              .then(data => {
      ...
      del(index, row) {
        this.$confirm(i18n.t("common.tip_info.delete_info"), i18n.t("common.tip_info.tips"), {
          ...
          const _data = { url: '/ws-material/del', params: { data: row.id } }
          this.$store.dispatch('fmsCommon/actionWmsPost', _data)
            .then(data => {
