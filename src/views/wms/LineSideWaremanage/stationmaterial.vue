  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'workStation', title: '工站ID', minWidth: 100, align: "center", queryType: 'input', set: true },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/station-material-barcode/list', params: this.queryParams }
        this.$store.dispatch('fmsCommon/actionWmsPost', _data)
          .then(data => {
            this.list = data.data
      ...
      submit(formName) {
        const _data = {
          url: '/station-material-barcode/edit', params: {
      ...
      save(formName) {
        ...
        let _data = { url: '/station-material-barcode/add', params: { data: this.defaultForm.params } }
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$store.dispatch('fmsCommon/actionWmsPost', _data)
              .then(data => {
      ...
      del(index, row) {
        this.$confirm(i18n.t("common.tip_info.delete_info"), i18n.t("common.tip_info.tips"), {
          ...
          const _data = { url: '/station-material-barcode/del', params: { data: row.id } }
          this.$store.dispatch('fmsCommon/actionWmsPost', _data)
            .then(data => {
