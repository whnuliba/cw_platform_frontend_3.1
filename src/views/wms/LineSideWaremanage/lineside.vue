  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          { field: 'whNo', title: '仓库编号', minWidth: 100, align: "center", query: true, queryType: 'input', set: true },
          { field: 'whName', title: '仓库名称', minWidth: 100, align: "center",queryType: 'input', set: true , query: true},
          { field: 'whDsc', title: '描述', minWidth: 100, align: "center", queryType: 'input', set: true },
          { field: 'status', title: '状态', minWidth: 100, align: "center", queryType: 'select', set: true },
          { field: 'whAddr', title: '仓库位置', minWidth: 100, align: "center", queryType: 'input', set: true , query: true},
          { field: 'whType', title: '仓库类型', minWidth: 100, align: "center", queryType: 'input', set: true },
    ...
    methods: {
      ...
      save(formName) {
        ...
        let _data = { url: '/warehouse/add', params: { data: this.defaultForm.params } }
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$store.dispatch('fmsCommon/actionWmsPost', _data)
              .then(data => {
      ...
      del(index, row) {
        this.$confirm(i18n.t("common.tip_info.delete_info"), i18n.t("common.tip_info.tips"), {
          ...
          const _data = { url: '/warehouse/del', params: { data: row.id } }
          this.$store.dispatch('fmsCommon/actionWmsPost', _data)
            .then(data => {
