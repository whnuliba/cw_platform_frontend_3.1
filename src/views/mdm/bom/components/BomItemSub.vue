 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/bom-sub/add",
          del:"/bom-sub/del",
          list:"/bom-sub/guest/get-sub-item"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [
                ...
                { field: 'pn', title: '物料编码',en_title:"PN",  align: "left",query:true,queryType:'input',editReadonly:true,set:true,require:true },               
                { field: 'pnName', title: '物料名称', align: "left",query:false,queryType:'input',set:true,require:true   },
                // { field: 'gn', title: '物料图号', align: "left",query:false,queryType:'input',set:true,require:true   },
                ...
                { field: 'priority', title: '优先级',hide:false, align: "left",query:false,queryType:'input',set:false,require:true   },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = {url:this.url.list,params:{data:this.bomItemId}}
  ...
  submit(formName){
       Object.assign(this.defaultForm.params,{routeItemId:this.routeItemId})
  ...
  query(){
   ...
   selectOptions(){
       //初始化线体信息
       let _data = {url:'/constant/tool-model',params:{}}
       this.$store.dispatch('fmsCommon/actionMdmPost',_data)
      .then(data => {
           this.initSelect.type = data.map(c=>{
             return {
               label:c.name,
               value:c.value
             }
