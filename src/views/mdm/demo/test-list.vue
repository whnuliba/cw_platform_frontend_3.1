 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
                { field: 'name', title: '姓名', align: "left",query:true,queryType:'input',set:true,editReadonly:true,require:true   },
                { field: 'age', title: '年龄', align: "left",query:true,queryType:'input',set:true,require:true   },               
