  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/process-bom/add",
          del:"/process-bom/del",
          list:"/process-bom/guest/get-material-by-itemid"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [
                { field: 'pn', title: '物料编码',en_title:"PN",align: "left",query:false,queryType:'input',set:true,require:true, width:130},   
                { field: 'pnName', title: '物料名称',width:120, align: 'center' ,query:false,set:true,queryType:'input', width:230 },            
                // { field: 'gn', title: '图号',width:100, align: "left",query:false,queryType:'input',set:true,require:true   },        
                { field: 'qty', title: '数量',width:60,align: "left",query:false,queryType:'input',set:true,require:true   },               
                { field: 'remark', title: '备注', align: 'center' ,query:false,set:true,queryType:'input' },
