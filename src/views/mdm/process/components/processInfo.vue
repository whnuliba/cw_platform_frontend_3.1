 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
                { field: 'pcNo', title: '工序编码',en_title:"TrayNo",  align: "left",query:true,queryType:'input',set:true,require:true },               
                { field: 'pcName', title: '工序名称', align: "left",query:true,queryType:'input',set:true,require:true   },
                { field: 'createTime', title: '创建日期', align: 'center' ,hide:true,query:false,queryType:'date', width:140 },
                { field: 'pcDsc', title: '工序描述', align: "left",queryType:'input',set:true,require:true  },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = {url:'/process/list',params:this.queryParams}
  ...
  submit(formName){
       const _data = {url:'/process/add',params:{
  ...
  query(){
   ...
   save(formName){
      ...
      let _data = {url:'/process/add',params:{data:this.defaultForm.params}}
         this.$refs[formName].validate((valid) => {
          if (valid) {
              this.$store.dispatch('fmsCommon/actionMdmPost',_data)
              .then(data => {
   ...
   del(index,row){
      this.$confirm(i18n.t("common.tip_info.delete_info"), i18n.t("common.tip_info.tips"), {
          ...
          type: 'warning'
                ...
                const _data = {url:'/process/del',params:{data:row.id}}
                this.$store.dispatch('fmsCommon/actionMdmPost',_data)
                .then(data => {
