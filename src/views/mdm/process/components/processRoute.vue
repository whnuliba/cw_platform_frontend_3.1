<template>
  ...
  <div class="filter-container">
     ...
     <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="processRouteRowClick"  @row-dblclick="showDetails" >
...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      table_mark:"mdm_process_route_lst",
      ...
      url:{
          add:"/process-route/add",
          del:"/process-route/del",
      ...
      cols: [
                ...
                { field: 'pnName', title: '产品名称',en_title:"pnName",  align: "left",query:true,queryType:'input',set:true,require:true, width:120 },                        
                { field: 'routeNo', title: '路径编码', align: "left",query:false,queryType:'input',set:true,require:true   },
                { field: 'routeName', title: '路径名称', align: "left",query:false,queryType:'input',set:true,require:true   },
                { field: 'routeDsc', title: '路径描述',hide:true, align: "left",query:false,queryType:'input',set:true,require:true   },               
                { field: 'status', title: '状态',hide:true, align: "left",query:false,queryType:'input',set:false,require:true   },
                { field: 'createTime', title: '创建日期',hide:true, align: 'center' ,query:false,queryType:'date' },
                // { field: 'gn', title: '图号',query:true,align: "left",queryType:'input',set:false,require:true  },
                { field: 'gpath', title: '图号路径',hide:true, align: "left",queryType:'input',set:true,require:true  },
  ...
  methods: {
       processRouteRowClick(row, column, event){
             this.$emit('changeprocessRoute',  row)
       },
         initData(arr){
       let args = {}
          arr.map(c=>{
