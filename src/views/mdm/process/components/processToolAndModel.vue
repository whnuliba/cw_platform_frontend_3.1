 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          add:"/process-tool/add",
          del:"/process-tool/del",
          list:"/process-tool/guest/get-tool-by-itemid"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [
                { field: 'pn', title: '物料编码',en_title:"PN",  align: "left",query:false,queryType:'input',set:true,require:true },             
                { field: 'pn', title: '工装名称',en_title:"PN",  align: "left",query:false,queryType:'input',set:false,require:true },               
                // { field: 'gn', title: '图号', align: "left",query:false,queryType:'input',set:true,require:true   },        
                { field: 'qty', title: '数量',align: "left",query:false,queryType:'input',set:true,require:true   },               
                { field: 'toolNo', title: '工装编码', align: 'center' ,hide:true,query:false,set:true,queryType:'input' },
                { field: 'type', title: '工装类型', align: 'center' ,query:false,set:true,queryType:'select' },
    ]
    }
    ...
    watch:{
    processToolAndModelId:function(val){
       this.routeItemId = val
       this.getList()
       this.selectOptions()
    }
  },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = {url:this.url.list,params:{data:this.routeItemId}}
