  ...
  data() {
    const  _initdata ={
      ...
      cols: [
                ...
                { field: 'routeDsc', title: '路径描述', align: "left",query:false,queryType:'input',set:true,require:true   },               
                { field: 'status', title: '状态', align: "left",query:false,queryType:'input',set:false,require:true   },
                { field: 'createTime', title: '创建日期', align: 'center' ,query:false,queryType:'date' },
                { field: 'gn', title: '图号', align: "left",queryType:'input',set:false,require:true  },
                { field: 'gpath', title: '图号路径', align: "left",queryType:'input',set:true,require:true  },
