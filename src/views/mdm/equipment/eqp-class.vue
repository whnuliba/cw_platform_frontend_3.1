  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          { field: 'className', title: '分类名称', align: 'left', width: '105px', query: true, queryType: 'input', set: true, require: true },
          { field: 'classCode', title: '分类编码', align: 'left', editReadonly: true, width: '105px', query: true, queryType: 'input', set: true, require: false },
          { field: 'classDesc', title: '描述', align: 'left', query: false, queryType: 'input', set: true, require: false },
          { field: 'remark', title: '备注', align: 'left', query: false, queryType: 'input', set: true, require: false },
          { field: 'udf1', title: '自定义1', align: 'left', query: false, queryType: 'input', set: true, require: false },
          { field: 'udf2', title: '自定义2', align: 'left', query: false, queryType: 'input', set: true, require: false },
          { field: 'udf3', title: '自定义3', align: 'left', query: false, queryType: 'input', set: true, require: false },
        ]
      }
