  ...
  <div class="app-container">
        ...
        <div class="filter-container">
          ...
          <el-button type="info"     class="filter-item" @click="reset" >
           ...
           <el-button type="warning"   class="filter-item" @click="add" v-ele-show="{btnCode:'factory_info_add'}">
               {{ $t("common.btn.add") }}
           </el-button>
        </div>
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="220">
        ...
        <template slot-scope="scope">
          <el-button type="primary" size="small"  icon="el-icon-edit" @click="edit(scope.row)">
           ...
           &nbsp;
           <el-button type="warning" v-ele-show="{btnCode:'DEL_PROCESS_INFO'}"   size="small" icon="el-icon-edit" @click="del(scope.$index,scope.row)">
              {{ $t("common.btn.delete") }}
          </el-button>
        </template>
      </el-table-column>
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
                { field: 'factoryNo', title: '工厂编码',en_title:"TrayNo", minWidth: 200,editReadonly:true, align: "left",query:true,queryType:'input',set:true,require:true },               
                { field: 'factoryName', title: '工厂名称', minWidth: 200, align: "left",query:true,queryType:'input',set:true,require:true   },
                ...
                { field: 'createUser', title: '创建人', align: "left",queryType:'input',set:false,require:true  },
