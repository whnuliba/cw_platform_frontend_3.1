  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="rowClick">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="120">
        ...
        <!-- <template slot-scope="scope">
          <i v-ele-show="{btnCode:'cutting_add'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
          <i v-ele-show="{btnCode:'cutting_del'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" />
        </template> -->
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        { field: 'windNo', title: '卷号', align: 'left', query: true, queryType: 'input', set: true, require: false },
        { field: 'cellQty', title: '卷芯数量', align: 'left', query: false, queryType: 'input', set: true, require: false },
        ...
        { field: 'pn', title: '电芯型号', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'subPn', title: '子型号', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'lineNo', title: '线别', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'materialNo', title: '物料条码', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'materialLot', title: '物料批次', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'lotNo', title: '生产批次', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'okQty', title: '合格数量', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'ngQty', title: 'NG数量', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'orderNo', title: '工单编码', align: 'left', query: false, queryType: 'input', set: true, require: false },
