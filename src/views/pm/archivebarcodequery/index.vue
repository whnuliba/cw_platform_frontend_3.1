  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        { field: 'vendorName', title: '供应商名称', align: 'center', query: false, queryType: 'select', set: true, require: false, width:100 },
        ...
        { field: 'isPack', title: '最小包装', align: 'right', query: false, queryType: 'select', set: true, require: false },
