  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="rowClick">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
        ...
        <!-- <template slot-scope="scope">
          <i v-ele-show="{btnCode:'bake_add'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        { field: 'inStation', title: '上料时间', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'outStation', title: '出料时间', align: 'left', query: false, queryType: 'input', set: true, require: false },
