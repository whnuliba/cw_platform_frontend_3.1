    ...
    <div class="model-workshop">
      <div class="model-workshop-top">
        <el-tabs v-model="activeName1" type="border-card" >
          <el-tab-pane label="烘烤工单" name="an1Tab1">
          ...
          <el-tab-pane label="小卷" name="an2Tab2">
            <div class="mode-workshop-container-bottom">
              <component :is="bakeComponents" ref="homogenateId" :activeName1="activeName1" :homogenateId="homogenateId"  > </component >
            </div>
          </el-tab-pane>
        </el-tabs>
      </div>
...
import bakesmallvolume from './components/bakesmallvolume'

import i18n from '@/lang' ;
export default {
  name: 'bake-list',
  components: { Pagination, bake, bakesmallvolume },
  ...
  data() {
    const _initdata = {
      orderComponents: 'bake',
      bakeComponents: 'bakesmallvolume',
      orderId: '',
      homogenateId: '',
      activeName1: 'an1Tab1',
      activeName2: 'an2Tab2'
  ...
  methods: {
    myChangeOrder(row) {
      this.$refs.homogenateId.reloadData(row.extId)
