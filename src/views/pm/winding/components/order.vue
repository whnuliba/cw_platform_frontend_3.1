  ...
  <div>
    <div class="filter-container">
     ...
     <el-button type="primary" class="filter-item" @click="query">
      ...
      <!-- <el-button type="warning"   class="filter-item" @click="add" v-ele-show="{btnCode:'linePacking_add'}">
        {{ $t("common.btn.add") }}
      </el-button> -->
    </div>
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="rowClick" @row-dblclick="rowdoubleClick">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="100">
        ...
        <template slot-scope="scope">
          <!-- <i v-ele-show="{btnCode:'linePacking_add'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
          <i v-ele-show="{btnCode:'linePacking_del'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" /> -->
...
export default {
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        { field: 'factoryNo', title: '工作中心',editReadonly:true, align: "left",query:false,queryType:'input',set:true,require:true, width:120},
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParams.requestData.orderType = 'JR';
