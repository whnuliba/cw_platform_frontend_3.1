    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="rowClick" @row-dblclick="showDetails">
      ...
      <!-- <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
        ...
        <template slot-scope="scope">
          ...
          &nbsp;
          <i v-ele-show="{btnCode:'lineMaterial_del'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" />
        </template>
      </el-table-column> -->
    </el-table>
...
export default {
  ...
  data() {
    const _initdata = {
      table_mark: 'pp_lineMaterial_list',
      dialogFormVisible: false,
      allowDisable: false,
      dialogSelectFieldVisible: false,
      wid: '',
      url: {
        add: '/lineMaterial/add',
        del: '/lineMaterial/del',
        list: '/lineMaterial/list'
      },
      queryParams: {
        requestData: {
        }
      ...
      cols: [
        ...
        { field: 'materialName', title: '物料名称', align: 'left', query: false, queryType: 'input', set: true, require: false, width:200 },
        ...
        { field: 'wno', title: '仓库编码', align: 'left', query: false, queryType: 'input', set: true, require: false, width:100 },
        // { field: 'orderNo', title: '工单', align: 'left', query: false, queryType: 'input', set: true, require: false, width:130 },
