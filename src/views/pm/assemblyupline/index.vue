...
export default {
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        { field: 'trayNo', title: '托盘编码', align: 'left', query: true, queryType: 'input', editReadonly: true, set: true, require: false, width:150 },
        { field: 'deviceNo', title: '设备编码', align: 'left', query: true, queryType: 'input', set: false, require: false },

        { field: 'windNo', title: '卷号', align: 'left', query: true, queryType: 'input', set: true, require: false,width:100 },
        ...
        { field: 'inStation', title: '托盘入站时间', align: 'center', query: false, queryType: 'input', set: true, require: false, width:150 },
        { field: 'outStation', title: '托盘出站时间', align: 'center', query: false, queryType: 'input', set: true, require: false, width:150 },
        // { field: 'materialNo', title: '物料条码', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:150 },
        // { field: 'materialLot', title: '物料批次', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:150 },
        // { field: 'lotNo', title: '生产批次', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:80 },
        { field: 'completeState', title: '完工状态', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:80 },
        // { field: 'upSeq', title: '上线序号', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:80 },
        { field: 'status', title: '状态', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, width:80 },
      ]
    }
