...
export default {
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        { field: 'ch', title: '通道', align: 'right', query: false, queryType: 'input', editReadonly: true, set: true, require: false,width:50 },
        { field: 'septum1', title: '隔膜1', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, },
        { field: 'septum2', title: '隔膜2', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, },
        { field: 'vanode', title: '正极卷', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, },
        { field: 'vcathode', title: '负极卷', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, },
  ...
  methods: {
    ...
    getList(val) {
      ...
      const _data = { url: this.url.cells, params: {data:val} }
