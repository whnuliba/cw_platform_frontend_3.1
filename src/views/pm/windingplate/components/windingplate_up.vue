  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        // { field: 'cellQty', title: '卷芯数量', align: 'left', query: true, queryType: 'input', set: true, require: false,width:100 },
        { field: 'trayNo', title: '托盘编码', align: 'left', query: true, queryType: 'input', editReadonly: true, set: true, require: false,},
        // { field: 'inStation', title: '托盘入站时间', align: 'center', query: false, queryType: 'input', set: true, require: false, width:150 },
        { field: 'outStation', title: '托盘出站时间', align: 'center', query: false, queryType: 'input', set: true, require: false,  },
        // { field: 'pn', title: '电芯型号', align: 'left', query: true, queryType: 'input', set: true, require: true },
        // { field: 'subPn', title: '子型号', align: 'left', query: true, queryType: 'input', set: true, require: true },
        // { field: 'lineNo', title: '线别', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false },
        { field: 'status', title: '状态', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false, },
