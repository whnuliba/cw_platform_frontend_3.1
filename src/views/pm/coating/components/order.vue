  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        { field: 'pn', title: '产品码', align: 'left', query: true, queryType: 'input', set: true, require: true, width:120 },
        ...
        { field: 'lotNo', title: '批次号', query: true, align: 'left', queryType: 'input', set: true, require: true },
