    ...
    <div class="model-workshop">
      <div class="model-workshop-top">
        <el-tabs v-model="activeName1" type="border-card" >
          ...
          <el-tab-pane label="涂布工单详情" name="an2Tab2">
            <div class="mode-workshop-container-bottom">
              <component :is="coatingComponents" ref="homogenateId" :activeName1="activeName1" :homogenateId="homogenateId"  > </component >
            </div>
          </el-tab-pane>
        </el-tabs>
      </div>
...
export default {
  name: 'coating-list',
  components: { Pagination, order, coating },
