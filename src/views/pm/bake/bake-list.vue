  ...
  <div class="app-container">
    ...
    <el-dialog v-el-drag-dialog :title="$t('common.btn.edit')" :visible.sync="dialogFormVisible" width="700px">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="defaultForm.params.seq==='' || defaultForm.params.seq===null" type="primary" @click="save('defaultForm.params')">  {{ $t("common.btn.save") }}</el-button>
        <el-button v-if="defaultForm.params.seq!='' && defaultForm.params.seq!=null" type="primary" @click="submit('defaultForm.params')">  {{ $t("common.btn.submit") }}</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    const _initdata = {
      ...
      url: {
        add: '/scada-bake/add',
        del: '/scada-bake/del',
        list: '/scada-bake/list',
        submit: '/scada-bake/completeProduct',
        edit: '/scada-bake/edit',
      },
      queryParams: {
        requestData: { }
      },
      initSelect: {
        ...
        transitionStatus: [{ label: '待卷绕', value: 0 }, { label: '已下转', value: 1 }, { label: '静置超时', value: 2 }],
      },
      defaultForm: {
        row: {},
        params: {
      ...
      cols: [
        { field: 'deviceNo', title: '设备号', align: 'left', query: true, queryType: 'input', set: false, require: false,width:120 },
        { field: 'createTime', title: '创建时间', align: 'left', query: false, queryType: 'input', set: false, require: false,width:145 },
        { field: 'positionId', title: '仓位编码', align: 'left', query: false, queryType: 'input', set: false, require: false,width:120 },
        { field: 'palletId', title: '托盘编码', align: 'left', query: false, queryType: 'input', set: false, require: false,width:120 },
        { field: 'cellId', title: '库存单元', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'system', title: '体系', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'batch', title: '批次', align: 'left', query: true, queryType: 'input', set: false, require: false,width:120 },
        { field: 'subBatch', title: '子批次', align: 'left', query: false, queryType: 'input', set: false, require: false,width:120 },
        { field: 'bigRoll', title: '大卷号', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'smallRoll', title: '小卷号', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'sn', title: '产品条码', align: 'left', query: true, queryType: 'input', set: false, require: false,width:120 },
        { field: 'transitionStatus', title: '转序状态', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'moistureValue', title: '水分值', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'quantity', title: '良品数', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'pole', title: '产品极性', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'workPlace', title: '机器编号', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'nextPlace', title: '下一车间', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'orderId', title: '指令编号', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'status', title: '状态', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'creator', title: '作业人员', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'bakedTime', title: '烘烤完成时间', align: 'left', query: false, queryType: 'input', set: false, require: false,width:145 },
        { field: 'inTime', title: '出库时间', align: 'left', query: false, queryType: 'input', set: false, require: false,width:145 },
        { field: 'deviceTime', title: '设备创建时间', align: 'left', query: false, queryType: 'input', set: false, require: false,width:145 },
      ],
    }
  ...
  methods: {
    ...
    submit(formName) {
      const _data = { url: this.url.edit, params: {
