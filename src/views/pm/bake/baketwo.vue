  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        { field: 'electrode', title: '极性', align: 'left', query: true, queryType: 'select', set: true, require: false },
        { field: 'lotNo', title: '批次', align: 'left', query: true, queryType: 'input', set: false, require: false,width:120 },
        // { field: 'subBatch', title: '子批次', align: 'left', query: false, queryType: 'input', set: false, require: false,width:120 },
        { field: 'mwindNo', title: '大卷号', align: 'left', query: true, queryType: 'input', set: false, require: false },
        { field: 'swindNo', title: '小卷号', align: 'left', query: false, queryType: 'input', set: false, require: false },
        { field: 'barCode', title: '条码', align: 'left', query: true, queryType: 'input', set: false, require: false },
