...
export default {
  ...
  props: {
    // 外部传入的内容，用于实现双向绑定
    // value: String,
    lineProcessBarcodePackId: String
  },
  data() {
    const _initdata = {
      table_mark: 'pp_lineProcessBarcodePack_list',
      dialogFormVisible: false,
      allowDisable: false,
      dialogSelectFieldVisible: false,
      sn: '',
      url: {
        add: '/lineProcessBarcodePack/add',
        del: '/lineProcessBarcodePack/del',
        list: '/lineProcessBarcodePack/list'
      },
      queryParams: {
        requestData: { }
      },
      ...
      cols: [
        { field: 'barcode', title: '物料条码', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: false },
        { field: 'scanTime', title: '扫码时间', align: 'left', query: false, queryType: 'input', set: true, require: false },
        ...
        { field: 'unit', title: '单位', align: 'left', query: false, queryType: 'select', set: true, require: false },
  ...
  watch: {
    lineProcessBarcodePackId: function(val) {
      this.queryParams.requestData.linePackId = val
      this.getList()
      this.selectOptions()
    }
  },
