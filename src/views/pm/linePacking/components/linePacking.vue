...
export default {
  ...
  data() {
    const _initdata = {
      table_mark: 'pm_linePacking_list',
      ...
      cols: [
        ...
        { field: 'recordTime', title: '开单日期', align: 'left', query: false, queryType: 'input', set: true, require: false },
        ...
        { field: 'wdirection', title: '目标仓库', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'wsource', title: '源仓库', align: 'left', query: false, queryType: 'input', set: true, require: false }
      ]
    }
