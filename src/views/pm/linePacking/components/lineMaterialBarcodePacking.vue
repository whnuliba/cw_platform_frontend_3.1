...
export default {
  ...
  data() {
    const _initdata = {
      table_mark: 'pm_lineMaterialBarcodePacking_list',
      dialogFormVisible: false,
      allowDisable: false,
      dialogSelectFieldVisible: false,
      sn: '',
      url: {
        add: '/lineMaterialBarcodePacking/add',
        del: '/lineMaterialBarcodePacking/del',
        list: '/lineMaterialBarcodePacking/list'
      },
      queryParams: {
        requestData: { }
      },
      ...
      cols: [
        ...
        { field: 'vendorNo', title: '供应商编码', align: 'left', width: '90px', query: false, queryType: 'input', set: true, require: false },
        { field: 'vendorName', title: '供应商名称', align: 'left', width: '90px', query: false, queryType: 'select', set: true, require: false },
        ...
        { field: 'materialId', title: '物料ID', hide: true, align: 'left', query: false, queryType: 'input', set: true, require: false }
      ]
    }
