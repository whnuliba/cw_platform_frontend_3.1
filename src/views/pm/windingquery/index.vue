...
export default {
  ...
  data() {
    const _initdata = {
      ...
      url: {
        ...
        items:'/line-arch-barcode/items',
        query:'/VWindingSvolume/query',
      },
      queryParams: {
        requestData: { }
      },
      ...
      cols: [
        ...
        { field: 'orderNo', title: '工单编码', align: 'left', query: true, queryType: 'input', set: false, require: false, width:140 },
        { field: 'person', title: '人员', align: 'left', query: false, queryType: 'input', set: false, require: false, width:100 },
        ...
        { field: 'barCode', title: '小卷条码', align: 'left', query: true, queryType: 'input', set: false, require: false, width:150 },
        ...
        { field: 'electrode', title: '极性', align: 'center', query: false, queryType: 'input', set: true, require: false, width:50 },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = { url: this.url.query, params: this.queryParams }
      this.$store.dispatch('fmsCommon/actionProductPost', _data)
        .then(data => {
          this.list = data.data
