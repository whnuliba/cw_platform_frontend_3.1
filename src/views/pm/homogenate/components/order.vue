  ...
  <div>
    ...
    <el-table :cell-style="setRowStyle" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="rowClick" @row-dblclick="rowdoubleClick">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="120">
        ...
        <template slot-scope="scope">
          <!-- <i v-ele-show="{btnCode:'order_add'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
          <i v-ele-show="{btnCode:'order_del'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" /> -->
...
export default {
  ...
  data() {
    const _initdata = {
      ...
      cols: [
        { field: 'orderNo', title: '工单编号', align: 'left', query: true, queryType: 'input', set: true, require: true, width:110 },
        { field: 'extOrderNo', title: 'SAP单号', align: 'left', query: true, queryType: 'input', set: true, require: true, width:110 },
        { field: 'pn', title: '产品编码', align: 'left', query: true, queryType: 'input', set: true, require: true, width:120 },
        { field: 'pn2', title: '产品型号', align: 'left', query: false, queryType: 'input', set: true, require: true, width:120},
        { field: 'factoryNo', title: '工作中心', editReadonly: true, align: 'left', query: false, queryType: 'select', set: true, require: true, width:120 },
        { field: 'orderType', title: '工单类型', align: 'left', query: false, queryType: 'select', set: true, require: true, editReadonly: true },
        { field: 'electrode', title: '极性', align: 'center', query: false, queryType: 'select', set: true, require: true, width:50 },
        { field: 'qty1', title: '数量', query: false, align: 'left', queryType: 'input', set: true, require: true },
        ...
        { field: 'planStartTime', title: '开始时间', align: 'left', query: false, queryType: 'datetime', set: true, require: true, width:150 },
        { field: 'planEndTime', title: '结束时间', align: 'left', query: false, queryType: 'datetime', set: true, require: true, width:150 },
        { field: 'completeTime', title: '结束时间', align: 'left', query: false, queryType: 'datetime', set: true, require: true, width:150 },
      ]
    }
