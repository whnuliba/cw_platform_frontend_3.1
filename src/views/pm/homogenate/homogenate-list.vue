    ...
    <div class="model-workshop">
      <div class="model-workshop-top">
        <el-tabs v-model="activeName1" type="border-card" >
          ...
          <el-tab-pane label="匀浆工单详情" name="an2Tab2">
...
import homogenate from './components/homogenate'

import i18n from '@/lang' ;
export default {
  name: 'homogenate-list',
  components: { Pagination, order, homogenate },
  ...
  data() {
    const _initdata = {
      ...
      homogenateComponents: 'homogenate',
      orderId: '',
      homogenateId: '',
      activeName1: 'an1Tab1',
      activeName2: 'an2Tab2'
  ...
  methods: {
    myChangeOrder(row) {
      this.$refs.homogenateId.reloadData(row.orderNo)
