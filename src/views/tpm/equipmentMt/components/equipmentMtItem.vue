...
export default {
  ...
  data() {
    const _initdata = {
      ...
      equipmentMtId: '',
      url: {
        add: '/equipmentMtItem/add',
        del: '/equipmentMtItem/del',
        list: '/equipmentMtItem/guest/get-equipmentMtItem'
      },
      queryParams: {
        requestData: { }
      },
      ...
      cols: [
        ...
        { field: 'mtContent', title: '检查内容', align: 'left', query: false, queryType: 'input', set: true, require: true, columnType: 'textareainput',layout:"row", width: 240, },
        { field: 'mtWay', title: '检查方式', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: true, columnType: 'textareainput',layout:"row",width: 240, },
        { field: 'mtRequire', title: '检查要求', align: 'left', query: false, queryType: 'input', set: true, require: true,columnType: 'textareainput',layout:"row", width: 240, },
