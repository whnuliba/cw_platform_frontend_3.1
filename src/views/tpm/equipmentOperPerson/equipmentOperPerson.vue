<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-ele-show="{btnCode:'equipment_oper_person_add'}" type="warning" class="filter-item" @click="add">
        {{ $t("common.btn.add") }}
      </el-button>
    </div>
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-dblclick="showDetails">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
        ...
        <template slot-scope="scope">
          <i v-ele-show="{btnCode:'equipment_oper_person_edit'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
          <i v-ele-show="{btnCode:'equipment_oper_person_del'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" />
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        value1: new Date(),
        url: {
          add: '/equipmentOperPerson/add',
          del: '/equipmentOperPerson/del',
          list: '/equipmentOperPerson/list',
        },
        queryParams: {
          requestData: {}
        },
        ...
        cols: [
          ...
          { field: 'deivceName', title: '设备名称', align: 'left', query: false, queryType: 'input', editReadonly: true, set: true, require: true },
          { field: 'mtPerson', title: '维修保养人员', align: 'left', query: false, queryType: 'input', set: true, require: true },
          { field: 'checkPerson', title: '点检人员', align: 'left', query: false, queryType: 'input', set: true, require: true },
          { field: 'lubPersion', title: '润滑人员', align: 'left', query: false, queryType: 'input', set: true, require: true },
