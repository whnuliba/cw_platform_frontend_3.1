    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="equipmentMtPartRowClick">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="160">
        ...
        <template slot-scope="scope">
          ...
          <el-button type="warning" v-ele-show="{btnCode:'equipment_lub_part_finish'}" v-if="scope.row.status != 106" size="small" @click="edit(scope.row)">
            {{ "完成" }}
          </el-button>
        </template>
      </el-table-column>
  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        equipmentMtId: '',
        url: {
          add: '/equipmentLubricationPlanItem/add',
          del: '/equipmentLubricationPlanItem/del',
          list: '/equipmentLubricationPlanItem/guest/get-lubricationPlanItemHed',
          finish: '/equipmentLubricationPlanItem/get-completeLubricationPlanItem'
        },
        queryParams: {
          requestData: {}
        },
        ...
        cols: [
          ...
          { field: 'checkResult', title: '润滑结论', align: 'left', query: false, queryType: 'input', set: true, require: true },
          ...
          { field: 'lubricationTime', title: '润滑完成时间', align: 'left', query: false, queryType: 'datetime', set: false, require: true },
          { field: 'lubricationPerson', title: '润滑人员', align: 'left', query: false, queryType: 'input', set: false, require: false },
