  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        value1: new Date(),
        url: {
          add: '/equipmentAlarmItem/add',
          del: '/equipmentAlarmItem/del',
          list: '/equipmentAlarmItem/list'
        },
        queryParams: {
          requestData: {}
        },
        ...
        cols: [
          ...
          { field: 'alarmNo', title: '报警编码', align: 'left', query: false, queryType: 'input', set: false, require: false },
          { field: 'alarmName', title: '报警名称', align: 'left', query: false, queryType: 'input', set: false, require: false },
          { field: 'alarmTime', title: '报警时间', align: 'left', query: false, queryType: 'datetime', editReadonly: false, set: true, require: true },
          { field: 'alarmEndTime', title: '恢复时间', align: 'left', query: false, queryType: 'datetime', editReadonly: false, set: true, require: true },
