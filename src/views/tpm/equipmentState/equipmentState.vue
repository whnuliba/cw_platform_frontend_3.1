  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        value1: new Date(),
        url: {
          add: '/equipmentState/add',
          del: '/equipmentState/del',
          list: '/equipmentState/list'
        },
        queryParams: {
          requestData: {}
        },
        ...
        cols: [
          ...
          { field: 'stateNo', title: '状态编码', align: 'left', query: false, queryType: 'input', set: false, require: false },
          { field: 'stateName', title: '状态名称', align: 'left', query: false, queryType: 'input', set: false, require: false },
          { field: 'stateTime', title: '状态时间', align: 'left', query: false, queryType: 'input', editReadonly: false, set: true, require: true },
