/* * @CreatAuthor: 宋丹峰 * @UpdateAuthor: (...) * @Description: 生产监控-生产物流监控 */
<template>
  <el-row>
    <el-col :span="24">
      <div :style="{ display: 'flex', 'justify-content': 'center', margin: '5px 0' }">
        <el-select
          ...
          @change="chartChange"
          class="chartSelect"
          :style="{ width: '12%', margin: '0 10px 0 0' }"
        >
          <el-option
        ...
        <el-button @click="monitorBtn" type="primary" id="monitorBtn">{{
          $t("common.btn.monitor")
        }}</el-button>
        <el-button id="SaveButton" @click="zoomIn" type="primary">{{
          $t("common.btn.enlarge")
        }}</el-button>
        <el-button id="SaveDesign" @click="zoomOut" type="primary">{{
          $t("common.btn.lessen")
        }}</el-button>
        <el-button @click="fullScreen" type="primary">{{
          $t("common.btn.fullScreen")
        }}</el-button>
      </div>
      <div class="design-and-inspect">
        <div ref="myDiagramSpan" class="myDiagramSpan">
          ...
          <ul id="contextMenu" class="menu">
            <li id="read" class="menu-item" @click="cxcommand">
              {{ translateText("roadInfo") }}
            </li>
            <li
              id="current-lot"
              class="menu-item"
              @click="cxcommand"
              :style="{ display: this.stacker ? 'none' : 'block' }"
            >
              {{ translateText("pltInfo") }}
            </li>
            <li id="task-info" class="menu-item" @click="cxcommand"
            :style="{ display: this.stacker ? 'none' : 'block' }">
              {{ translateText("taskInfo") }}
            </li>
            <li
              id="plc-enter"
              class="menu-item"
          ...
          <el-dialog
            ...
            :title="translateText('deviceInfo')"
            :modal="false"
            customClass="nodeModal"
            @close="closeDialog"
          >
            <!-- 功能按钮 -->
            <el-row class="specialbutton">
              <el-button type="danger" icon="el-icon-delete" @click="clearPlc" round>{{
                translateText("clearPLC")
              }}</el-button>
              <el-button type="primary" icon="el-icon-edit" @click="writePlc" round>{{
                translateText("editPLC")
              }}</el-button>
              <el-button type="warning" icon="el-icon-star-off" @click="movePlc" round>{{
                translateText("movePLC")
              }}</el-button>
            </el-row>
            <el-tabs v-model="activeName" @tab-click="handleClick">
                  ...
                  <div style="margin-left: 100px">
                    ...
                    >
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'locNum'))"
                          >
                        ...
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'taskNum'))"
                          >
                            <el-input
                              v-model="conveyorTemp.conveyorTask.taskNum"
                              :disabled="isDisabled"
                            />
                          </el-form-item>
                        </el-col>
                      ...
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'trayNum'))"
                          >
                            <el-input
                              v-model="conveyorTemp.conveyorTask.trayNum"
                              :disabled="isDisabled"
                            />
                          </el-form-item>
                        </el-col>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'trayType'))"
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.trayType"
                              :popper-append-to-body="false"
                              style="width: 100%"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.trayType"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                      ...
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'matlState'))"
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.matlState"
                              style="width: 100%"
                              :popper-append-to-body="false"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.matlState"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                        ...
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'trayCount'))"
                          >
                            <el-input
                              v-model="conveyorTemp.conveyorTask.trayCount"
                              :disabled="isDisabled"
                            />
                          </el-form-item>
                        </el-col>
                      ...
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="
                              commonI18n(getItem(conveyorColumns, 'otherState_PLC'))
                            "
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.otherState_PLC"
                              style="width: 100%"
                              :popper-append-to-body="false"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.otherState_PLC"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                        ...
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'otherState_PC'))"
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.otherState_PC"
                              :popper-append-to-body="false"
                              style="width: 100%"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.otherState_PC"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                      ...
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'scanState'))"
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.scanState"
                              style="width: 100%"
                              :popper-append-to-body="false"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.scanState"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                        ...
                        <el-col :span="12">
                          <el-form-item
                            :label="
                              commonI18n(getItem(conveyorColumns, 'interfaceState'))
                            "
                          >
                            <el-select
                              v-model="conveyorTemp.conveyorTask.interfaceState"
                              style="width: 100%"
                              :popper-append-to-body="false"
                              :disabled="isDisabled"
                            >
                              <el-option
                                v-for="item in initSelect.interfaceState"
                                :key="item.value"
                                :value="item.value"
                                :label="item.label"
                              />
                      ...
                      <el-row>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'fromLocNum'))"
                          >
                            <el-input
                              v-model="conveyorTemp.conveyorTask.fromLocNum"
                              :disabled="isDisabled"
                            />
                          </el-form-item>
                        </el-col>
                        <el-col :span="12">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'toLocNum'))"
                          >
                            <el-input
                              v-model="conveyorTemp.conveyorTask.toLocNum"
                              :disabled="isDisabled"
                            />
                          </el-form-item>
                        </el-col>
                      ...
                      <el-row>
                        <el-col :span="24">
                          <el-form-item
                            :label="commonI18n(getItem(conveyorColumns, 'errInfo'))"
                          >
                            <el-input
                              type="textarea"
                              :rows="2"
                              v-model="conveyorTemp.errInfo"
                              :disabled="true"
                            ></el-input>
                          </el-form-item>
                        </el-col>
                      ...
                      <el-form-item v-if="btnVisible">
                        <el-button @click="cancelWritePlc">{{
                          $t("common.btn.cancel")
                        }}</el-button>
                        <el-button type="primary" @click="submitWritePlc">{{
                          $t("common.btn.ok")
                        }}</el-button>
                      </el-form-item>
                    </el-form>
              ...
              <el-tab-pane :label="translateText('pltInfo')" name="second">
                <el-radio-group v-model="pltIndex" class="radio-group">
                  <div
                    v-for="(i, index) in radioSwitchData"
                    :key="`ra${index}`"
                    ...
                    >
                      <el-col :span="8">
                        ...
                        >
                          <el-input
                            v-if="!item.type"
                            v-model="trayTemp[item.field]"
                            :disabled="item.readonly != 'true' ? false : true"
                          />
                          <el-select
                    ...
                    <div v-for="(item, i) in staColumns" :key="i" style="display: inline">
                      <el-col :span="12">
                        <el-form-item :label="commonI18n(item)" :prop="item.field">
                          <el-input
                            v-if="item.field != 'useState' && !item.type"
                            style="width: 146%"
                            v-model="staTemp[item.field]"
                            :disabled="item.readonly != 'true' ? false : true"
                          />
                          <el-select
                            v-else-if="item.type === 'select'"
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisible_plclear = false">{{
                $t("common.btn.cancel")
              }}</el-button>
              <el-button type="primary" @click="plClear">{{
                $t("common.btn.ok")
              }}</el-button>
            </span>
          </el-dialog>
    ...
    return {
      ...
      textI18n: {
        ...
        postTaskNum: {
          zh: "下发的任务号",
          en: "postTaskNum",
          vn: "Số nhiệm vụ đã ban hành",
        },
        execTaskNum: {
          zh: "执行的任务号",
          en: "execTaskNum",
          vn: "Số nhiệm vụ được thực hiện",
        },
  ...
  mounted() {
    ...
    this.$store
      ...
      .then((data) => {
        ...
        this.initChartParam =
          this.chartSel && this.chartSel.hasOwnProperty("label")
            ? [parseInt(this.chartSel.label.slice(0, 3))]
            : [];
  ...
  methods: {
    ...
    fromPage(pages) {
      ...
      this.$store
        .dispatch("fmsCommon/actionWcsPost", _data)
        .then((data) => {
          let carryTypeData = this.selColumns["selOne"],
            newData = data.data,
            tt = this.pltCate,
            Matl = this.MatlCate,
            locData = this.locInfo;
    ...
    stockerEqInfo(carryType) {
      ...
      this.$store
        ...
        .then((data) => {
          let useData = {
            url: "/api/Stocker/GetStockerAutoState",
            params: { data: carryType },
          };
          this.$store
            .dispatch("fmsCommon/actionWcsPost", useData)
            .then((datas) => {
              this.useShow = datas;
    ...
    initDiagram(id) {
      ...
      this.$store
        ...
        .then((data) => {
          ...
          let conveyorNum = this.monitorNodeData.filter(
            (node) =>
              node.eqType === "输送线" ||
              node.eqType === "圆盘" ||
              node.eqType === "OCV" ||
          ...
          if (
            (newMonitor.includes(101) &&
              newMonitor.includes(102) &&
              newMonitor.includes(103)) ||
            (newMonitor.includes(101) && newMonitor.includes(102)) ||
            (newMonitor.includes(102) && newMonitor.includes(103)) ||
    ...
    getConveyorTask(carryType, locNum, plclotNum) {
      // 设备信息
      let _data = {
        url: "/api/Conveyor/GetConveyorTask",
        params: { data: { carryType: carryType, locNum: locNum } },
      };
      this.$store
        .dispatch("fmsCommon/actionWcsPost", _data)
        .then((data) => {
          ...
          // 托盘信息
          if (
            this.conveyorTemp.conveyorTask.trayNum != null &&
            this.conveyorTemp.conveyorTask.trayNum != 0
          ) {
            _data = {
              url: "/api/Conveyor/GetPltByTrayNum",
              params: { data: this.conveyorTemp.conveyorTask.trayNum },
            };
            this.$store
              .dispatch("fmsCommon/actionWcsPost", _data)
              .then((data) => {
    ...
    staInfo(locNum) {
      ...
      this.$store
        ...
        .then((data) => {
          if (data) {
            let addInfo = this.selFilter.filter(
              (item) => item.carryType === this.carryType && item.staNum === this.staCode
            );
    ...
    selectOptions() {
      ...
      this.$store
        .dispatch("fmsCommon/actionWcsPost", areaData)
        .then((data) => {
      ...
      this.$store
        .dispatch("fmsCommon/actionWcsPost", eqNumData)
        .then((data) => {
          // 移动弹窗设备号
    ...
    clearPlc() {
      ...
      this.$confirm(
        this.getClearTipText(this.conveyorTemp.locNum),
        ...
        .then(() => {
          const _data = {
            url: "/api/Conveyor/ClearConveyorTask",
            params: {
              data: { carryType: task.carryType, locNum: this.conveyorTemp.locNum },
            },
          };
          this.$store
            .dispatch("fmsCommon/actionWcsPost", _data)
    ...
    submitWritePlc() {
      let params = {
        data: {
          ...this.conveyorTemp.conveyorTask,
          locNum: Number(this.conveyorTemp.locNum),
        },
      };
      this.$confirm(
        i18n.t("common.tip_info.common_info"),
        i18n.t("common.tip_info.tips"),
        {
          confirmButtonText: i18n.t("common.btn.ok"),
          cancelButtonText: i18n.t("common.btn.cancel"),
    ...
    cancelWritePlc() {
      let _data = {
        url: "/api/Conveyor/GetConveyorTask",
        params: { data: { carryType: this.carryType, locNum: this.staNum } },
      };
      this.$store
        .dispatch("fmsCommon/actionWcsPost", _data)
        .then((data) => {
    ...
    init() {
      ...
      myDiagram.nodeTemplate = Make(
        ...
        Make(
          ...
          Make(
            ...
            // 点击图形会使节点外边框变成蓝色
            // new go.Binding("stroke", "isSelected", (s, node) =>
            //   s ? "#999" : "#999"
            // ).ofObject(),
          ...
          Make(
            go.Panel,
            "Table", // 面板的table布局 (注意:vue中要写在spot布局中，写在外面spot布局的块会缺失)
            Make(
              go.TextBlock,
      ...
      function showContextMenu(obj, diagram, tool) {
        if (
          ...
          obj.data.eqType === "圆盘" ||
          obj.data.eqType === "OCV" ||
          obj.data.eqType === "DCIR" ||
          obj.data.eqType === "拔钉机" ||
          obj.data.eqType === "预充电柜"
        ) {
          if (obj.data.eqType === "堆垛机") {
            // 右击获取站台信息
            _this.stacker = true;
      ...
      function handlerDC(e, obj) {
        ...
        if (_this.temp.eqType === "堆垛机" && data.color !== "maroon") {
          ...
          _this.parentLabel = {
            first: _this.translateText("deviceInfo"),
            second: _this.translateText("taskInfo"),
          };
          (_this.rowOne = _this.translateText("command")),
            (_this.rowTwo = {
              first: _this.translateText("doing"),
              second: _this.translateText("waiting"),
            }),
            (_this.moveColumns = [
          ...
          (_this.temp.eqType === "输送线" ||
            _this.temp.eqType === "圆盘" ||
            _this.temp.eqType === "OCV" ||
            _this.temp.eqType === "DCIR" ||
            _this.temp.eqType === "拔钉机" ||
            _this.temp.eqType === "预充电柜" ||
            _this.temp.eqType === "盐水箱") &&
          data.st !== "red"
        ) {
          ...
          _this.parentLabel = {
            first: _this.$t("const.rackInfo"),
            second: _this.$t("const.pltInfo"),
          };
      ...
      function nodeInfo(data) {
        ...
        if (
          data.st === "red" ||
          data.color === "rgb(136, 0, 34, 0.5)" ||
          data.color === "maroon"
        ) {
          info =
            data.text || data.carryType
              ? `[${data.text || data.carryType}]` +
                _this.translateText("communicationError")
              : _this.translateText("communicationError");
        } else {
          switch (data.eqType) {
            case "输送线":
            case "圆盘":
              if(data.eqType){info +=_this.translateText("deviceType") + ":" + data.eqType}
              if(data.text){info +='\n'+_this.translateText("deviceCode") + ":" + data.text}
              if(data.carryType){info +='\n'+_this.translateText("carryType") + ":" + data.carryType}
              if(data.ctrlCode){info +='\n'+_this.translateText("ctrlCode") + ":" + data.ctrlCode}
              if(data.rackCode){info +='\n'+_this.translateText("rackCode") + ":" + data.rackCode}
              if(data.trayNum){info +='\n'+_this.translateText("trayNum") + ":" + data.trayNum} 
              if(data.faultInfos){info +='\n'+_this.translateText("faultInfos") + ":" + data.faultInfos}
              if(data.光电信号){info +='\n'+_this.translateText("光电信号") + ":" + data.光电信号}
              if(data.操作方式){info +='\n'+_this.translateText("操作方式") + ":" + data.操作方式}
              if(data.运行状态){info +='\n'+_this.translateText("运行状态") + ":" + data.运行状态}
              if(data.货叉安全){info +='\n'+_this.translateText("货叉安全") + ":" + data.货叉安全}
              if(data.staName){info +='\n'+_this.translateText("staName") + ":" + data.staName}
              // info = `${
              //   data.eqType ? _this.translateText("deviceType") + ":" + data.eqType : ""
              // }
              //                       ${
              //                         data.text
              //                           ? _this.translateText("deviceCode") +
              //                             ":" +
              //                             data.text
              //                           : ""
              //                       }
              ...
              //                       ${
              //                         data.faultInfos
              //                           ? _this.translateText("faultInfos") +
              //                             ":" +
              //                             data.faultInfos
              //                           : ""
              //                       }
              ...
              //                       ${
              //                         data.操作方式
              //                           ? _this.translateText("deviceMode") +
              //                             ":" +
              //                             data.操作方式
              //                           : ""
              //                       }
              //                       ${
              //                         data.运行状态
              //                           ? _this.translateText("deviceState") +
              //                             ":" +
              //                             data.运行状态
              //                           : ""
              //                       }
              //                       ${
              //                         data.货叉安全
              //                           ? _this.translateText("forkStatus") +
              //                             ":" +
              //                             data.货叉安全
              //                           : ""
              //                       }
            ...
            case "堆垛机":
              ...
              if(data.eqType){info +=_this.translateText("deviceType") + ":" + data.eqType}
              if(data.taskAutoState){info +='\n'+_this.translateText("autoTask") + ":" + _this.$t("common.ProcessFlowList.enable")}else{info +='\n'+_this.translateText("autoTask") + ":" + _this.$t("common.ProcessFlowList.disabled")}
              if(data.taskNum){info +='\n'+_this.translateText("postTaskNum") + ":" + data.taskNum}
              if(data.execTaskNum){info +='\n'+_this.translateText("execTaskNum") + ":" + data.execTaskNum}
              if(data.deviceMode){info +='\n'+_this.translateText("deviceMode") + ":" + data.deviceMode}
              if(data.deviceState){info +='\n'+_this.translateText("deviceState") + ":" + data.deviceState}
              if(data.execState){info +='\n'+_this.translateText("execState") + ":" + data.execState}
              if(data.fork1State===0){info +='\n'+_this.translateText("fork1State") +":" +_this.translateText("empty")}else if(data.fork1State===1){info +='\n'+_this.translateText("fork1State") +":" +_this.translateText("filled")}else if(data.fork1State===2){info +='\n'+_this.translateText("fork1State") +":" +_this.translateText("forbidden")}
              if(data.fork2State===0){info +='\n'+_this.translateText("fork2State") +":" +_this.translateText("empty")}else if(data.fork2State===1){info +='\n'+_this.translateText("fork2State") +":" +_this.translateText("filled")}else if(data.fork2State===2){info +='\n'+_this.translateText("fork2State") +":" +_this.translateText("forbidden")}
              if(data.row && data.column && data.layer){info +='\n'+_this.translateText("location") +":" + newRow +newolumn +newLayer}
              if(data.taskFlag){info +='\n'+_this.translateText("postFlag") + ":" +  _this.$t("const.permit.forbidden")}else{info +='\n'+_this.translateText("postFlag") + ":" +  _this.$t("const.permit.allowed")}
              // info = `${
              //   data.eqType ? _this.translateText("deviceType") + ":" + data.eqType : ""
              // }
              //                       ${
              //                         data.taskAutoState
              //                           ? _this.translateText("autoTask") +
              //                             ":" +
              //                             _this.$t("common.ProcessFlowList.enable")
              //                           : _this.translateText("autoTask") +
              //                             ":" +
              //                             _this.$t("common.ProcessFlowList.disabled")
              //                       }
              //                       ${
              //                         data.taskNum
              //                           ? _this.translateText("postTaskNum") +
              //                             ":" +
              //                             data.taskNum
              //                           : ""
              //                       }
              //                       ${
              //                         data.execTaskNum
              //                           ? _this.translateText("execTaskNum") +
              //                             ":" +
              //                             data.execTaskNum
              //                           : ""
              //                       }
              ...
              //                       ${
              //                         data.fork1State === 0
              //                           ? _this.translateText("fork1State") +
              //                             ":" +
              //                             _this.translateText("empty")
              //                           : data.fork1State === 1
              //                           ? _this.translateText("fork1State") +
              //                             ":" +
              //                             _this.translateText("filled")
              //                           : data.fork1State === 2
              //                           ? _this.translateText("fork1State") +
              //                             ":" +
              //                             _this.translateText("forbidden")
              //                           : ""
              //                       }
              //                       ${
              //                         data.fork2State === 0
              //                           ? _this.translateText("fork2State") +
              //                             ":" +
              //                             _this.translateText("empty")
              //                           : data.fork2State === 1
              //                           ? _this.translateText("fork2State") +
              ...
              //                       }
              //                       ${
              //                         data.row && data.column && data.layer
              //                           ? _this.translateText("location") +
              //                             ":" +
              //                             newRow +
              //                             newolumn +
              //                             newLayer
              ...
              //                       }
              //                       ${
              //                         _this.translateText("postFlag") +
              //                         ":" +
              //                         (data.taskFlag
              //                           ? _this.$t("const.permit.forbidden")
              //                           : _this.$t("const.permit.allowed"))
              //                       }
              //                       `;
              break;
            case "库位":
              console.log(data)
              if (data.eqType) {info += _this.translateText("deviceType") + ":" + data.eqType}
              if (data.text) {info +='\n'+ _this.translateText("rowNum") + ":" + data.text}
              // info = `${
              //   data.eqType ? _this.translateText("deviceType") + ":" + data.eqType : ""
              // }
              //                       ${
            ...
            case "扫码器":
              ...
              if (data.carryType) {info +='\n'+ _this.translateText("carryType") + ":" + data.carryType}
              if (data.ctrlCode) {info +='\n'+ _this.translateText("ctrlCode") + ":" + data.ctrlCode}
              if (data.checkFlag) {info +='\n'+ _this.translateText("checkFlag") + ":" + data.checkFlag}
              // info = `${
              //   data.eqType ? _this.translateText("deviceType") + ":" + data.eqType : ""
              // }
              //                       ${
            ...
            case "OCV":
              ...
              //                   ${
              //                     data.eqType
              //                       ? _this.translateText("deviceType") +
              //                         ":" +
              //                         data.eqType
              //                       : ""
              //                   }
        ...
        this.$store
          ...
          .then((data) => {
            let carryTypeData = this.selColumns["selOne"],
              ...
              Matl = this.MatlCate,
              locData = this.locInfo,
              { interfaceState, matlState, scanState } = this.initSelect;
            let tbData = newData.map((item) => {
              carryTypeData.forEach((ca) => {
                if (parseInt(item.carryType) === parseInt(ca.id)) {
                  item.carryType = ca.name;
              ...
              item.useState =
                item.useState == 1
                  ? this.$t("common.ProcessFlowList.efficient")
                  : this.$t("common.ProcessFlowList.invalid");
              return item;
            });
            this.contextTableOne = tbData;
          })
    ...
    getStockerInfo(carryType, searchApi) {
      ...
      // 堆垛机任务信息
      let _data1 = {
        url: "/api/CarryTask/GetStockerCarryTasks",
        params: { data: carryType },
      };
      this.$store
        .dispatch("fmsCommon/actionWcsPost", _data1) //
        .then((data) => {
          if (data.length !== 0) {
            ...
            let _data2 = {
              url: "/api/CarryTask/GetCurrentTaskDetail",
              params: { data: data[0].taskGroupId },
            };
            this.$store
              .dispatch("fmsCommon/actionWcsPost", _data2)
              .then((datas) => {
                let _data = {
                  url: "/api/Stocker/GetStockerTask",
                  params: { data: carryType },
                };
                this.$store
                  .dispatch("fmsCommon/actionWcsPost", _data)
                  .then((stackTaskData) => {
                    let NewData =
                      datas.length !== 0
                        ? datas.filter((item) => item.postState === 1)
                        : [];
                    this.currentTaskDetailId = NewData[0].id;
                    let pltCodeArr =
                      data.length !== 0
                        ? data.filter((item) => item.taskId === NewData[0].taskId)
                        : [];
                    ...
                    if (NewData.length !== 0) {
                      ...
                      NewData[0].isFire = NewData[0].isFire
                        ? this.$t("const.yesNo.yes")
                        : this.$t("const.yesNo.no");
    ...
    rePostFunc() {
      this.$confirm(
        this.$t("const.sureToDo") + this.$t("taskOperate.postAgain") + " ?",
        this.$t("common.tip_info.tips"),
        {
          confirmButtonText: this.$t("common.btn.ok"),
          cancelButtonText: this.$t("common.btn.cancel"),
          type: "warning",
          ...
          rePost(params).then((res) => {
            if (res.data.code === 200) {
              this.$message({
                type: "success",
                message:
                  this.$t("taskOperate.postAgain") + this.$t("const.result.success"),
              });
    ...
    forceFinishFunc() {
      this.$confirm(
        this.$t("const.sureToDo") + this.$t("taskOperate.completeForcibly") + " ?",
        this.$t("common.tip_info.tips"),
        {
          confirmButtonText: this.$t("common.btn.ok"),
          cancelButtonText: this.$t("common.btn.cancel"),
          ...
          forceFinish(params).then((res) => {
            if (res.data.code === 200) {
              this.$message({
                type: "success",
                message:
                  this.$t("taskOperate.completeForcibly") +
                  this.$t("const.result.success"),
              });
              this.getStockerInfo(carryType, false);
            }
          });
    ...
    plcTask1() {
      ...
      let conveyParams = {
        ...
        params: this.initChartParam,
      }; //输送线设备信息和任务信息
      let newMonitorData = this.monitorNodeData.filter(
        (node) =>
          node.eqType === "输送线" ||
          node.eqType === "圆盘" ||
          node.eqType === "OCV" ||
      ...
      this.$store
        .dispatch("fmsCommon/actionWcsPost", conveyParams)
        .then((data) => {
          let { task, info } = data;
          ...
          if (!task.length) {
            ...
            for (let i = newMonitorData.length - 1; i >= 0; i--) {
              ...
              for (let a = task.length - 1; a >= 0; a--) {
                let item = task[a];
                if (
                  parseInt(item.locNum) === parseInt(node.ctrlCode) &&
                  parseInt(item.carryType) === parseInt(node.carryType)
                ) {
                  onLine = true;
                  let nodeSet = this.diagram.model.findNodeDataForKey(node.key);
                  this.diagram.model.setDataProperty(nodeSet, "st", "gray");
      ...
      conveyParams = null;
      // 扫码器监控
      let scanMonitorData = this.monitorNodeData.filter(
        (item) => item.eqType === "扫码器"
      );
      let scanParams = { url: "/api/PlcData/ScanerPlcInfo", params: [] };
      this.$store
        .dispatch("fmsCommon/actionWcsPost", scanParams)
        .then((data) => {
          scanMonitorData.forEach((node) => {
            let scanExist = false;
            data.forEach((scan) => {
              if (
                parseInt(node.ctrlCode) === parseInt(scan.locNum) &&
                parseInt(node.carryType) === parseInt(scan.carryType)
              ) {
                scanExist = true;
                let nodeScan = null;
                ...
                switch (scan.checkFlag) {
                  ...
                  case 1: // 扫码完成
                    ...
                    this.diagram.model.setDataProperty(
                      nodeScan,
                      "checkFlag",
                      this.$t("const.scanState.scanned")
                    );
                    break;
                  case 2: // 比对完成
                    nodeScan = this.diagram.model.findNodeDataForKey(node.key);
                    ...
                    this.diagram.model.setDataProperty(
                      nodeScan,
                      "checkFlag",
                      this.$t("const.scanState.matched")
                    );
                    break;
                  case 3: // 比对失败
                    nodeScan = this.diagram.model.findNodeDataForKey(node.key);
                    ...
                    this.diagram.model.setDataProperty(
                      nodeScan,
                      "checkFlag",
                      this.$t("const.scanState.matchFail")
                    );
                    break;
                  case 9: // 申请重扫
                    nodeScan = this.diagram.model.findNodeDataForKey(node.key);
                  ...
                  case 11: // 入库请求
                    ...
                    this.diagram.model.setDataProperty(
                      nodeScan,
                      "checkFlag",
                      this.$t("const.scanState.inboundRequest")
                    );
                    break;
                  case 12: // 入库成功
                    nodeScan = this.diagram.model.findNodeDataForKey(node.key);
                  ...
                  case 13: // 入库失败
                    ...
                    this.diagram.model.setDataProperty(
                      nodeScan,
                      "checkFlag",
                      this.$t("const.scanState.importFail")
                    );
                    break;
                  default:
                    break;
      ...
      this.$store
        .dispatch("fmsCommon/actionWcsPost", stockerParams)
        .then((data) => {
          let { task, info } = data;
                  ...
                  .then((res) => {
                    ...
                    if (
                      ...
                      this.diagram.model.setDataProperty(
                        nodeAttr,
                        "deviceMode",
                        this.stockerSel.selTwo[fo.deviceMode].name
                      );
                      this.diagram.model.setDataProperty(
                        nodeAttr1,
                        "groupTextColor",
                      ...
                      if (fo.deviceMode == 5) {
                        switch (
                          ...
                          case 3: // 故障 = 红色闪烁报警
                            ...
                            this.diagram.model.setDataProperty(
                              nodeSet,
                              "deviceState",
                              this.stockerSel.selThree[3].name
                            );
                            break;
                          case 2: // 空闲 = 绿色
                            if (!fo.taskAutoState) {
                              ...
                              this.diagram.model.setDataProperty(
                                nodeSet,
                                "deviceState",
                                this.stockerSel.selThree[2].name
                              );
                              if (!nodeSet.taskFlag) {
                                this.diagram.model.setDataProperty(
                                  nodeSet,
                          ...
                          case 1: // 工作 = 蓝色
                            ...
                            this.diagram.model.setDataProperty(
                              nodeSet,
                              "deviceState",
                              this.stockerSel.selThree[1].name
                            );
                            if (!nodeSet.taskFlag) {
                              this.diagram.model.setDataProperty(
                                nodeSet,
                          ...
                          case 0: // 待机 = 棕色
                            ...
                            this.diagram.model.setDataProperty(
                              nodeSet,
                              "deviceState",
                              this.stockerSel.selThree[0].name
                            );
                            if (!nodeSet.taskFlag) {
                              this.diagram.model.setDataProperty(
                                nodeSet,
                        ...
                        this.diagram.model.setDataProperty(
                          nodeSet,
                          "deviceState",
                          this.stockerSel.selThree[fo.deviceMode].name
                        );
                        if (!nodeSet.taskFlag) {
