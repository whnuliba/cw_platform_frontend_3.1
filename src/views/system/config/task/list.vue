  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%"
     ...
     @row-dblclick="showDetails">
      ...
      <el-table-column align="left" :label="$t('common.btn.operate')" width="300" fixed="right">
        <template slot-scope="scope">
...
<script>
  ...
  import script_editer from './components/script-editer-taskList';
  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          { field: 'scheduleCode', title: '调度编码', minWidth: 150, align: "left" ,query: true, queryType: 'input', set: true,required:true,editReadonly:true  },
          { field: 'scheduleGrpCode', title: '调度组码', minWidth: 150, align: 'left', query: true, queryType: 'input', set: true,required:true ,editReadonly:true  },
          { field: 'businessCode', title: '业务编码', minWidth: 150, align: "left" ,query: true, queryType: 'input', set: true,required:true  },
          { field: 'cron', title: 'Cron', edit: 'text', align: 'center', width: 130 ,queryType: 'input', set: true,required:true},
          { field: 'interval', title: 'Interval[ms]', align: 'center', width: 150,  queryType: 'input', set: true,required:false },
          { field: 'scheduleName', title: '任务名称', edit: 'text', align: 'left', width: 200, queryType: 'input',set: true ,required:true},
          { field: 'triggerState', title: '状态', width: 120, align: 'center'} ,
          {
            field: 'jobClass', title: '执行类', edit: 'text', width: 500, align: 'left' ,queryType: 'input', set: true,required:true },
          { field: 'createUser', title: '创建人', width: 150, align: 'center' },
          { field: 'nextFireTime1', title: '下次执行时间', width: 150, align: 'center' },
          { field: 'preFireTime1', title: '上次执行时间', width: 150, align: 'center' },
          { field: 'startTime1', title: '开始时间', width: 150, align: 'center' },
          { field: 'endTime1', title: '结束时间', width: 150, align: 'center' },
          { field: 'createTime', title: '创建日期', align: 'center', width: 150 },
          { field: 'parameters', title: '参数', align: 'center', width: 150 },
    ...
    methods: {
      ...
      destory(hide = false) {
        ...
        this.defaultForm.params.scheduleType='TIMER'
      },
      start(){
      ...
      saveScript(){
        ...
        const _data = {url:'/schedule/update-parameter',params:{data:{parameters: _this.scriptOps.scriptValue,id: _this.scriptOps.scriptId}}}
        this.$store.dispatch('fmsCommon/actionFmsPost',_data)
        .then(data => {
            this.$message({
                      type: 'success',
