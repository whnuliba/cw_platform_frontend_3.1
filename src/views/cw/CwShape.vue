  ...
  export default {
    ...
    methods: {
      ...
      handleBlur(e) {
        ...
        const main_inner = document.querySelector(".main_designer_main");
      ...
      onMousedown(event) {
        ...
        function onMousemove(e) {
          ...
          //   },
          // }
          // _this.$bus.$emit('attributeData', attributeObj)
...
<style lang="scss" scoped>
  /* .shape {
    ...
    border: 1px Dashed #8a1212!important;
  ...
  .active {
    ...
    outline-offset: 4px;  /*采用offset模拟padding，会导致在模拟的padding内无法进行选中*/      
