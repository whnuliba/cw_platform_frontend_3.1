<template>
  <div ref="myref" v-bind="$attrs" class="svg-container" >
    ...
    <!-- 使用 path 绘制正方形 -->
    <path fill-rule="nonzero" d="M0 0 H20 V20 H0 Z" :fill="component.styles.fillColor" :stroke="component.styles.color" stroke-width="1" />
    <!-- 在正方形中间添加数字 -->
    <!-- <text x="50%" y="69%" text-anchor="middle" fill="#000" font-size="12">{{index+1}}</text> -->
  ...
  methods: {
    getStyleCols() {
      return [
        ...
        { field: 'fillColor', title: 'fillColor', queryType: 'colorpicker', defaultValue: 'pink', },
