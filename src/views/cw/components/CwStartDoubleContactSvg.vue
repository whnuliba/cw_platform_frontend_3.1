...
export default {
  ...
  methods: {
        ...
        [
          h('path', {
            attrs: {
              ...
              d: "M0 5 L0 25 L30 25 L30 30 L80 30 L80 0 L30 0 L30 5z M0 5 L5 5 L10 15 L5 25 L0 25 L5 15z M10 5 L75 5 L75 25 L10 25z M16 5 L19 5 L19 9 L20 9 L20 21 L19 21 L19 25 L17 25 L17 21 L16 21 L16 9 L17 9 L17 5z M26 5 L30 5 L30 9 L31 9 L31 21 L30 21 L30 25 L28 25 L28 21 L27 21 L27 9 L28 9 L28 5z M36 5 L40 5 L40 9 L41 9 L41 21 L40 21 L40 25 L38 25 L38 21 L37 21 L37 9 L38 9 L38 5z M46 5 L50 5 L50 9 L51 9 L51 21 L50 21 L50 25 L48 25 L48 21 L47 21 L47 9 L48 9 L48 5z M56 5 L60 5 L60 9 L61 9 L61 21 L60 21 L60 25 L58 25 L58 21 L57 21 L57 9 L58 9 L58 5z M66 5 L70 5 L70 9 L71 9 L71 21 L70 21 L70 25 L68 25 L68 21 L67 21 L67 9 L68 9 L68 5z",
    ...
    createSvgPath(createCount = 6, length = 30) {
        ...
        let contact_w = 1;
        let contact_h = 4;
        //let outBox = `M 0 ${boxSize} h ${length} v ${-boxSize} h ${width-length} v ${length} h ${-width+length} v ${-boxSize} h ${-length} z  M 0 ${boxSize} h ${boxSize} l ${interval-boxSize} ${(length-boxSize*2)/2} l ${-(interval-boxSize)} ${(length-boxSize*2)/2} h ${-boxSize} l ${(interval-boxSize)} ${-(length-boxSize*2)/2} z `

        let outBox = `M 0 ${boxSize}  v ${
          length - boxSize * 2
        } h ${length} v ${boxSize}  h ${width - length} v ${-length} h ${
          -width + length
        } v ${boxSize} h ${-length} z  M 0 ${boxSize} h ${boxSize} l ${interval - boxSize} ${
          (length - boxSize * 2) / 2
        ...
        let direction = `m ${dirSiz + cellSize} 0 h ${
          ...
          length -
          (boxSize + contact_h) * 2
        )} h ${contact_w} v ${-contact_h} h ${-contact_w * 2} z`;
