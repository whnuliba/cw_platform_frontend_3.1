...
export default {
  ...
  methods: {
    ...
    createSvgPath(createCount = 6, length = 30) {
        ...
        let outBox = `M 0 0 v ${length} h ${
          width - length
        }  v ${-boxSize}  h ${length}  v ${
          -length + boxSize
        } h ${-width} z M 0 ${boxSize} h ${boxSize} l ${interval - boxSize} ${
          (length - boxSize * 2) / 2
