...
export default {
  ...
  methods: {
    ...
    createSvgPath(createCount = 6, length = 30) {
      ...
      let outBox = `M 0 0 v ${length} h ${width} v ${-length} h ${-width} z  M 0 ${boxSize} h ${boxSize} l ${interval - boxSize
