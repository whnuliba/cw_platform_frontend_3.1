...
<script>
export default {
  name: 'CwLeftStartDoubleContactSvg',
  components: {},
  props: {
    componentModalObj: {
      type: Object,
  ...
  methods: {
        ...
        [
          h('path', {
            attrs: {
              ...
              d: "M0 5 L0 25 L30 25 L30 30 L80 30 L80 0 L30 0 L30 5z M80 5 L75 15 L80 25 L75 25 L70 15 L75 5z M5 5 L70 5 L70 25 L5 25z M11 5 L14 5 L14 9 L15 9 L15 21 L14 21 L14 25 L12 25 L12 21 L11 21 L11 9 L12 9 L12 5z M21 5 L25 5 L25 9 L26 9 L26 21 L25 21 L25 25 L23 25 L23 21 L22 21 L22 9 L23 9 L23 5z M31 5 L35 5 L35 9 L36 9 L36 21 L35 21 L35 25 L33 25 L33 21 L32 21 L32 9 L33 9 L33 5z M41 5 L45 5 L45 9 L46 9 L46 21 L45 21 L45 25 L43 25 L43 21 L42 21 L42 9 L43 9 L43 5z M51 5 L55 5 L55 9 L56 9 L56 21 L55 21 L55 25 L53 25 L53 21 L52 21 L52 9 L53 9 L53 5z M61 5 L65 5 L65 9 L66 9 L66 21 L65 21 L65 25 L63 25 L63 21 L62 21 L62 9 L63 9 L63 5z",
    ...
    createSvgPath(createCount = 6, length = 30) {
      ...
      let outBox = `M 0 ${boxSize} v ${length - 2 * boxSize
        } h ${length} v ${boxSize} h ${width - length} v ${-length} h ${-width + length
      ...
      let direction = `m ${dirSiz + cellSize} 0 h ${boxSize - contact_w
        } v ${contact_h} h ${contact_w} v ${length - (boxSize + contact_h) * 2
        } h ${-contact_w} v ${contact_h}  h ${-cellSize + contact_w * 2
        } v ${-contact_h} h ${-contact_w} v ${-(
          length -
