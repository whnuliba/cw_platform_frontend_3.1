...
export default {
  ...
  data() {
    return {
      ...
      // pathData: "M0 20 L10 20 L10 0 L35 0 L35 20 L55 20 L55 25 L90 25 L90 30 L55 30 L55 35 L35 35 L35 55 L10 55 L10 35 L0 35z M14 4 L16 4 L16 49 L14 49z M29 4 L31 4 L31 49 L29 49z",
  ...
  methods: {
        ...
        [
          h('path', {
            attrs: {
              ...
              d: "M0 20 L10 20 L10 0 L35 0 L35 20 L55 20 L55 25 L90 25 L90 30 L55 30 L55 35 L35 35 L35 55 L10 55 L10 35 L0 35z M14 4 L16 4 L16 49 L14 49z M29 4 L31 4 L31 49 L29 49z",
    ...
    createSvgPath(createCount = 6, length = 30) {
        ...
        let contact_h = 2;
        let offsetY = 20;   
        let outBox = `M 0 ${offsetY} h ${dirSiz} v ${-dirSiz * 2} h ${boxSize + dirSiz * 2} v ${
          dirSiz * 2
        ...
        let innerBox = `M ${dirSiz + contact_w} ${
          -dirSiz * 2 + contact_w + offsetY
        } h ${contact_h} v ${boxHeight - dirSiz - interval} h ${-contact_h} v ${dirSiz + interval - boxHeight} z
                  M ${dirSiz - contact_w - contact_h + boxSize + dirSiz * 2} ${
          -dirSiz * 2 + contact_w + offsetY
        } h ${contact_h} v ${boxHeight - dirSiz - interval} h ${-contact_h} v ${dirSiz + interval - boxHeight} z `;
