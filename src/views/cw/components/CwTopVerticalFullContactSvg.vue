...
<script>
export default {
  name: 'CwTopVerticalFullContactSvg',
  components: {},
  props: {
    componentModalObj: {
      type: Object,
  ...
  methods: {
    ...
    createSvgPath(createCount = 6, length = 30) {
      ...
      let contact_w = 1;
      let contact_h = 4;
      let outBox = `M 0 0  h ${length} v ${width}  h ${-length}  v ${-width} z  M ${boxSize} ${width} l ${(length - boxSize * 2) / 2
