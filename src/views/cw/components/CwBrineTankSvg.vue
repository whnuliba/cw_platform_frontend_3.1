<template>
  <div ref="myref" v-bind="$attrs" class="svg-container" >
    ...
    <!-- 在正方形中间添加数字 -->
    <text x="50%" y="60%" text-anchor="middle" fill="#000" font-size="12">盐水箱</text>
  </svg>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    getAttributeCols() {
      return [
        { field: 'text', title: '文本', queryType: 'input', require: false, query: true, hide: false, defaultValue: '盐水箱' },
