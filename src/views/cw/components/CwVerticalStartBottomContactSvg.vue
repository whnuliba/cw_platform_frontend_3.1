...
<script>
export default {
  name: 'CwVerticalStartBottomContactSvg',
  components: {},
  props: {
    componentModalObj: {
      type: Object,
  ...
  methods: {
        ...
        [
          h('path', {
            attrs: {
              ...
              d: "M0 0 L25 0 L25 30 L30 30 L30 80 L0 80z M5 0 L5 5 L15 10 L25 5 L25 0 L15 5z M5 10 L5 75 L25 75 L25 10z M5 16 L5 19 L9 19 L9 20 L21 20 L21 19 L25 19 L25 17 L21 17 L21 16 L9 16 L9 17 L5 17z M5 26 L5 29 L9 29 L9 30 L21 30 L21 29 L25 29 L25 27 L21 27 L21 26 L9 26 L9 27 L5 27z M5 36 L5 39 L9 39 L9 40 L21 40 L21 39 L25 39 L25 37 L21 37 L21 36 L9 36 L9 37 L5 37z M5 46 L5 49 L9 49 L9 50 L21 50 L21 49 L25 49 L25 47 L21 47 L21 46 L9 46 L9 47 L5 47z M5 56 L5 59 L9 59 L9 60 L21 60 L21 59 L25 59 L25 57 L21 57 L21 56 L9 56 L9 57 L5 57z M5 66 L5 69 L9 69 L9 70 L21 70 L21 69 L25 69 L25 67 L21 67 L21 66 L9 66 L9 67 L5 67z",
    ...
    createSvgPath(createCount = 6, length = 30) {
      ...
      let contact_w = 1;
      let contact_h = 4;
      //let outBox =  `M 0 0  v ${width} h ${length}  v ${-width+length} h ${-boxSize} v ${-length} z  M ${boxSize} 0 v ${boxSize} l ${(length-boxSize*2)/2} ${interval-boxSize} l ${(length-boxSize*2)/2} ${-(interval-boxSize)} v ${-boxSize} l ${-(length-boxSize*2)/2} ${(interval-boxSize)} z `
      let outBox = `M 0 0  h ${length - boxSize}  v ${length} h ${boxSize} v ${width - length
        } h ${-length} v ${-width} z  M ${boxSize} 0 v ${boxSize} l ${(length - boxSize * 2) / 2} ${interval - boxSize
