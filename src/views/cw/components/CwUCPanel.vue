<template>
  ...
  export default {
    ...
    methods: {
      ...
      this.$store.dispatch('fmsCommon/actionTaskPost', _data)
        .then(data => {
            ...
            {           
                   ...
                   //this.component.subComponent.length =0
                   //this.component.subComponent=this.page.element
                   this.componentData1 = this.page.element
            }           
              else{
                this.$message({
                type:"error",
      ...
      convertPx(data,parentData){
        ...
        if(data.match(/[\D]+/g)){
          switch (data.match(/[\D]+/g)[0]) {
            ...
            default: result = parseInt(data) + 10 + 'px';
          }
        }
      ...
      getAttributeCols() {
        return [
          { field: 'ucCode', title: '地址', queryType: 'input', require: false, query: true, hide: false },
