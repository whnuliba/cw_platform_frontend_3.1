...
<script>
export default {
  name: 'CwVerticalStartDoubleContactSvg',
  components: {},
  props: {
    componentModalObj: {
      type: Object,
  ...
  methods: {
        ...
        [
          h('path', {
            attrs: {
              ...
              d: "M5 0 L25 0 L25 30 L30 30 L30 80 L0 80 L0 30 L5 30z M5 0 L5 5 L15 10 L25 5 L25 0 L15 5z M5 10 L5 75 L25 75 L25 10z M5 16 L5 19 L9 19 L9 20 L21 20 L21 19 L25 19 L25 17 L21 17 L21 16 L9 16 L9 17 L5 17z M5 26 L5 30 L9 30 L9 31 L21 31 L21 30 L25 30 L25 28 L21 28 L21 27 L9 27 L9 28 L5 28z M5 36 L5 40 L9 40 L9 41 L21 41 L21 40 L25 40 L25 38 L21 38 L21 37 L9 37 L9 38 L5 38z M5 46 L5 50 L9 50 L9 51 L21 51 L21 50 L25 50 L25 48 L21 48 L21 47 L9 47 L9 48 L5 48z M5 56 L5 60 L9 60 L9 61 L21 61 L21 60 L25 60 L25 58 L21 58 L21 57 L9 57 L9 58 L5 58z M5 66 L5 70 L9 70 L9 71 L21 71 L21 70 L25 70 L25 68 L21 68 L21 67 L9 67 L9 68 L5 68z",
    ...
    createSvgPath(createCount = 6, length = 30) {
        ...
        let contact_w = 1;
        let contact_h = 4;
        //  let outBox = `M ${boxSize} 0 v ${length} h ${-boxSize} v ${width-length} h ${length} v ${-width+length} h ${-boxSize} v ${-length} z  M ${boxSize} 0 v ${boxSize} l ${(length-boxSize*2)/2} ${interval-boxSize} l ${(length-boxSize*2)/2} ${-(interval-boxSize)} v ${-boxSize} l ${-(length-boxSize*2)/2} ${(interval-boxSize)} z `

        let outBox = `M ${boxSize} 0 h ${
          length - boxSize * 2
        } v ${length} h ${boxSize} v ${width - length}  h ${-length} v ${
          -width + length
        } h ${boxSize} v ${-length} z  M ${boxSize} 0 v ${boxSize} l ${(length - boxSize * 2) / 2} ${
          interval - boxSize
        } l ${(length - boxSize * 2) / 2} ${-(interval - boxSize)} v ${-boxSize} l ${
          -(length - boxSize * 2) / 2
        } ${interval - boxSize} L ${boxSize} 0 z `;
