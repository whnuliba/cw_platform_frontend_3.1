<template>
  ...
  export default {
    ...
    components: { CwFlowComponent,CwSubPanel },
    props: {
      items: {
        type: Array,
        default: function() {
    ...
    watch:{
        'component.attribute.templateDocNo':{
            handler:function(nval,oval){
                 this.tempDocNo =nval
                 if(nval!==oval){
                      console.log(this.$refs)
                      this.$refs.myFloTemplate.loadFlowData()
                 }
            },
            deep:true
        }
    ...
    getAttributeCols() {
        return [
          { field: 'templateDocNo', title: '模板编码', queryType: 'input', require: false, query: true, hide: false },
