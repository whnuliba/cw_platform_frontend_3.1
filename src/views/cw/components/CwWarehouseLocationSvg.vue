<template>
  <div ref="myref" v-bind="$attrs" class="svg-container" :style="{width: component.styles.width, height:component.styles.height, flexDirection: flexDirection }">
    <svg class='warehouseLocationSvg' width="20px" height="20" v-for="(item,index) in boxArr" :key="index" @click="svgClick(index)">
      <path :d="outerSquarePath" fill="none" :stroke="clickNum ==  index ? 'red': 'black' " />
      <path :d="smallSquarePath1" :fill="item.bg1color" />
      <path :d="smallSquarePath2" :fill="item.bg2color" />
      <path :d="smallSquarePath3" :fill="item.bg3color" />
      <path :d="smallSquarePath4" :fill="item.bg4color" />
  ...
  methods: {
      ...
      return h(
        ...
        [
          ...
          h('path', {
            attrs: {
              fill: "red",
              d: 'M 2 2 H 10 V 10 H 2 Z',
            }
          }),
          h('path', {
            attrs: {
              fill: "green",
              d: 'M 10 2 H 18 V 10 H 10 Z',
            }
          }),
          h('path', {
            attrs: {
              fill: "blue",
              d: 'M 2 10 H 10 V 18 H 2 Z',
            }
          }),
          h('path', {
            attrs: {
              fill: "yellow",
              d: 'M 10 10 H 18 V 18 H 10 Z',
            }
          }),
        ]
      )
    ...
    createSvgPath() {
      let containerBox = [
       ...
       'M 10 2 H 18 V 10 H 10 Z',
       'M 2 10 H 10 V 18 H 2 Z',
       'M 10 10 H 18 V 18 H 10 Z'
      ];
      return containerBox;
    },
    handleDragEnd() { }
