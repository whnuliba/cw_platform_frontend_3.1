  ...
  data() {
    const _initdata = {
      ...
      cols: [
        ...
        // { field: 'isDialogUseCanvas', title: 'Canvas', queryType: 'switch', require: false, query: true, hide: false },
        // { field: 'isDialogConnectLine', title: '连线', queryType: 'switch', require: false, query: true, hide: false },
