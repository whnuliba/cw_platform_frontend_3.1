<template>
  <CwCascaders v-bind="$attrs" v-model="value" :options="options" :props="{ expandTrigger: 'hover' }" :itemStyle="itemStyle">
  </CwCascaders>
</template>
  <script>
  import CwCascaders from "@/components/Cw/CwCascader.vue"
  
  export default {
    name: 'CwCascader',
    components: { CwCascaders },
    props: {
      componentModalObj: {
        type: Object,
        default: () => {
