    ...
    <div class="container-menu"  :style="{width: `calc(100%-${lastX}px)` }">
      ...
      >
        <el-form
          ...
          :inline="true"
        >
          <div v-for="(item, i) in (dialogStatus == 'create' ? modalOptions : modalupdateOptions)" :key="i" style="width:'40%' margin-top:15px display:inline">
            <!-- 单行文本 -->
            <el-form-item
            ...
            >
              ...
              <el-select v-model="Menu[item.key]" style="width:180px;">
