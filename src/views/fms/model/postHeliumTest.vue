        ...
        >
          <el-tabs v-model="activeName" class="param-tab-style">
            ...
            <el-tab-pane
              ...
              name="param2"
            >
              <el-form-item label="泄漏率下限"  >
                <el-input v-model="processContent.doubleCheck.leakageLower" placeholder="泄漏率下限" :disabled="isFlowDts"></el-input>
              </el-form-item>
              <el-form-item label="泄漏率上限" >
                <el-input v-model="processContent.doubleCheck.leakageUpper" placeholder="泄漏率上限" :disabled="isFlowDts"></el-input>
              </el-form-item>
