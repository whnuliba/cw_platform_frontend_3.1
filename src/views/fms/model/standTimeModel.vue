          ...
          <!-- </el-col> -->
           ...
           <!--  <el-tab-pane
            ...
            >
               <el-col :span="24" :class="colHeight">  :style="{float:'left'}"
              <el-form-item label="静置时间下限(min)"  >
                <el-input v-model="processContent.doubleCheck.stl" placeholder="静置时间下限(min)" :disabled="isFlowDts"></el-input>
              </el-form-item>
              <el-form-item label="静置时间上限(min)" >
                <el-input v-model="processContent.doubleCheck.stu" placeholder="静置时间上限(min)" :disabled="isFlowDts"></el-input>
              </el-form-item>
               </el-col> 
            </el-tab-pane>  -->
