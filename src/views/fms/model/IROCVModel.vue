...
<!-- ----------------------------------------------------- -->
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick" class="param-tab-style">
                <el-tab-pane v-for="(content, order) in  cols " :key="order" :label="content.title" :name="content.label">
                    <div v-if="order == 1">
                        <div class="check_box">
                            <el-row class="colHeight">
                                <el-checkbox v-model="processContent.dcrEnable" value="item.dcrEnable"
                        ...
                        <div class="container accepted_container" v-for="(item, index) in content.col" :key="index">
                            <div class="title">{{ item.title }}</div>
                            <el-row>
                                <el-col :span="12">
                                    <el-row class="colHeight" v-for="(t, i) in item.Param" :key="i">
                                        <el-col :span="6" style="text-align:center">
                                            <el-form-item>
                                                <el-input v-if="t.label == 'DCR(mΩ)'"
                                                    v-model="processContent.recipe[t.value[0].value]" placeholder="下限"
                                                    :disabled="isFlowDts || !processContent.dcrEnable"
                                                    :step="t.step"></el-input>

                                                <el-input v-else
                                                    v-model="processContent.recipe[t.value[0].value]" placeholder="下限"
                                                    :disabled="isFlowDts" :step="t.step"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="10" style="line-height: 40px; text-align: center;">
                                            <span class="inline_item"> &lt= </span>
                                        ...
                                        <el-col :span="6" style="text-align:center">
                                            <el-form-item>
                                                <el-input v-if="t.label == 'DCR(mΩ)'"
                                                    v-model="processContent.recipe[t.value[1].value]" placeholder="上限"
                                                    :disabled="isFlowDts || !processContent.dcrEnable"
                                                    :step="t.step"></el-input>
                                ...
                                <el-col :span="11" v-if="item.sigma">
                                    <el-row class="colHeight">
                                    ...
                                    <el-row class="colHeight" v-for="(t, i) in item.sigmaParam" :key="i">
                                        <el-col :span="6" style="text-align:center">
                                            <el-form-item>
                                                <el-input v-if="t.label == 'Sigma_DCR(mΩ)'"
                                                    v-model="processContent.recipe[t.value[0].value]" placeholder="下限系数"
                                                    :disabled="isFlowDts || !processContent.sigmaDcrEnable || !processContent.sigmaEnable"
                                                    :step="t.step"></el-input>
                                                <el-input v-else
                                                    v-model="processContent.recipe[t.value[0].value]" placeholder="下限系数"
                                                    :disabled="isFlowDts || !processContent.sigmaEnable"
                                                    :step="t.step"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        ...
                                        <el-col :span="6" style="text-align:center">
                                            <el-form-item>
                                                <el-input v-if="t.label == 'Sigma_DCR(mΩ)'"
                                                    v-model="processContent.recipe[t.value[1].value]" placeholder="上限系数"
                                                    :disabled="isFlowDts || !processContent.sigmaDcrEnable || !processContent.sigmaEnable"
                                                    :step="t.step"></el-input>
                    ...
                    <div v-if=" order == 0 ">
                        <div class="container defective_goods" v-for="(item, index) in content.col" :key="index">
                            <div class="title">{{ item.title }}</div>
                            <el-row>
                                <el-col :span=" 12 ">
                                    <el-row class="colHeight" v-for="( t, i ) in  item.Param " :key=" i ">
                                        ...
                                        <el-col :span=" 6 " style="text-align:center">
                                            <el-form-item>
                                                <el-input v-model=" processContent.recipe[t.value[0].value] "
                                                    placeholder="" :disabled=" isFlowDts " :step=" t.step "></el-input>
                                            </el-form-item>
                                        </el-col>
                                        ...
                                        <el-col :span=" 6 " style="text-align:center">
                                            <el-form-item>
                                                <el-input v-model=" processContent.recipe[t.value[1].value] "
                                                    placeholder="" :disabled=" isFlowDts " :step=" t.step "></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                    ...
                    col: [
                        {
                            ...
                            Param: [
                                ...
                                //     step: "1",
                                //     value: [
                                //         { label: "电压下限(mV)", value: "ocvLower_G" },
                                //         { label: "电压上限(mV)", value: "ocvUpper_G" }
                                //     ]
                                // },
                                // {
                                //     label: "IR1(mΩ)",
                                //     step: "1",
                                //     value: [
                                //         { label: "内阻下限(mΩ)", value: "irLower_G" },
                                //         { label: "内阻上限(mΩ)", value: "irUpper_G" },
                                //     ]
                                // },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_G" },
                                        { label: "容量上限(mAh)", value: "capUpper_G" }
                                    ]
                                },
                                // {
                                //     label: "K",
                                //     step: "0.01",
                                //     value: [
                                //         { label: "K值下限", value: "kLower_G" },
                                //         { label: "K值上限", value: "kUpper_G" },
                                //     ]
                                // },
                                // {
                                //     label: "DCR(mΩ)",
                                //     step: "1",
                                //     value: [
                                //         { label: "DCR下限(mΩ)", value: "dcrLower_G" },
                                //         { label: "DCR上限(mΩ)", value: "dcrUpper_G" },
                                //     ]
                                // },
                            ],
                        }, {
                            ...
                            Param: [
                                ...
                                //     step: "1",
                                //     value: [
                                //         { label: "电压下限(mV)", value: "ocvLower_H" },
                                //         { label: "电压上限(mV)", value: "ocvUpper_H" }
                                //     ]
                                // },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_H" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_H" },
                                    ]
                                },
                                // {
                                //     label: "CAP(mAh)",
                                //     step: "1",
                                //     value: [
                                //         { label: "容量下限(mAh)", value: "capLower_H" },
                                //         { label: "容量上限(mAh)", value: "capUpper_H" }
                                //     ]
                                // },
                                // {
                                //     label: "K",
                                //     step: "0.01",
                                //     value: [
                                //         { label: "K值下限", value: "kLower_H" },
                                //         { label: "K值上限", value: "kUpper_H" },
                                //     ]
                                // },
                                // {
                                //     label: "DCR(mΩ)",
                                //     step: "1",
                                //     value: [
                                //         { label: "DCR下限(mΩ)", value: "dcrLower_H" },
                                //         { label: "DCR上限(mΩ)", value: "dcrUpper_H" },
                                //     ]
                                // },
                            ],
                        }, {
                            ...
                            Param: [
                                ...
                                //     step: "1",
                                //     value: [
                                //         { label: "电压下限(mV)", value: "ocvLower_I" },
                                //         { label: "电压上限(mV)", value: "ocvUpper_I" }
                                //     ]
                                // },
                                // {
                                //     label: "IR1(mΩ)",
                                //     step: "1",
                                //     value: [
                                //         { label: "内阻下限(mΩ)", value: "irLower_I" },
                                //         { label: "内阻上限(mΩ)", value: "irUpper_I" },
                                //     ]
                                // },
                                // {
                                //     label: "CAP(mAh)",
                                //     step: "1",
                                //     value: [
                                //         { label: "容量下限(mAh)", value: "capLower_I" },
                                //         { label: "容量上限(mAh)", value: "capUpper_I" }
                                //     ]
                                // },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_I" },
                                        { label: "K值上限", value: "kUpper_I" },
                                    ]
                                },
                                // {
                                //     label: "DCR(mΩ)",
                                //     step: "1",
                                //     value: [
                                //         { label: "DCR下限(mΩ)", value: "dcrLower_I" },
                                //         { label: "DCR上限(mΩ)", value: "dcrUpper_I" },
                                //     ]
                                // },
                            ],
                        },
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_A" },
                                        { label: "电压上限(mV)", value: "ocvUpper_A" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_A" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_A" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_A" },
                                        { label: "容量上限(mAh)", value: "capUpper_A" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_A" },
                                        { label: "K值上限", value: "kUpper_A" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_A" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_A" },
                                    ]
                                },
                            ], sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_A" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_A" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_A" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_A" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_A" },
                                        { label: "K值上限", value: "sigmaKUpper_A" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_A" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_A" },
                                    ]
                                }
                            ],
                        }, {
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_B" },
                                        { label: "电压上限(mV)", value: "ocvUpper_B" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_B" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_B" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_B" },
                                        { label: "容量上限(mAh)", value: "capUpper_B" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_B" },
                                        { label: "K值上限", value: "kUpper_B" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_B" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_B" },
                                    ]
                                },
                            ],
                            sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_B" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_B" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_B" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_B" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_B" },
                                        { label: "K值上限", value: "sigmaKUpper_B" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_B" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_B" },
                                    ]
                                }
                            ],
                        }, {
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_C" },
                                        { label: "电压上限(mV)", value: "ocvUpper_C" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_C" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_C" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_C" },
                                        { label: "容量上限(mAh)", value: "capUpper_C" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_C" },
                                        { label: "K值上限", value: "kUpper_C" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_C" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_C" },
                                    ]
                                },
                            ], sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_C" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_C" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_C" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_C" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_C" },
                                        { label: "K值上限", value: "sigmaKUpper_C" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_C" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_C" },
                                    ]
                                }
                            ],
                        }, {
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_D" },
                                        { label: "电压上限(mV)", value: "ocvUpper_D" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_D" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_D" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_D" },
                                        { label: "容量上限(mAh)", value: "capUpper_D" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_D" },
                                        { label: "K值上限", value: "kUpper_D" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_D" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_D" },
                                    ]
                                },
                            ],
                            sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_D" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_D" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_D" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_D" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_D" },
                                        { label: "K值上限", value: "sigmaKUpper_D" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_D" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_D" },
                                    ]
                                }
                            ],
                        }, {
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_E" },
                                        { label: "电压上限(mV)", value: "ocvUpper_E" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_E" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_E" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_E" },
                                        { label: "容量上限(mAh)", value: "capUpper_E" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "1",
                                    value: [
                                        { label: "K值下限", value: "kLower_E" },
                                        { label: "K值上限", value: "kUpper_E" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_E" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_E" },
                                    ]
                                },
                            ],
                            sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_E" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_E" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_E" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_E" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_E" },
                                        { label: "K值上限", value: "sigmaKUpper_E" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_E" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_E" },
                                    ]
                                }
                            ],
                        }, {
                            ...
                            Param: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "ocvLower_F" },
                                        { label: "电压上限(mV)", value: "ocvUpper_F" }
                                    ]
                                },
                                {
                                    label: "IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "irLower_F" },
                                        { label: "内阻上限(mΩ)", value: "irUpper_F" },
                                    ]
                                },
                                {
                                    label: "CAP(mAh)",
                                    step: "1",
                                    value: [
                                        { label: "容量下限(mAh)", value: "capLower_F" },
                                        { label: "容量上限(mAh)", value: "capUpper_F" }
                                    ]
                                },
                                {
                                    label: "K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "kLower_F" },
                                        { label: "K值上限", value: "kUpper_F" },
                                    ]
                                },
                                {
                                    label: "DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "dcrLower_F" },
                                        { label: "DCR上限(mΩ)", value: "dcrUpper_F" },
                                    ]
                                },
                            ],
                            sigmaParam: [
                                {
                                    ...
                                    step: "1",
                                    value: [
                                        { label: "电压下限(mV)", value: "sigmaOcvLower_F" },
                                        { label: "电压上限(mV)", value: "sigmaOcvUpper_F" }
                                    ]
                                },
                                {
                                    label: "Sigma_IR1(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "内阻下限(mΩ)", value: "sigmaIrLower_F" },
                                        { label: "内阻上限(mΩ)", value: "sigmaIrUpper_F" },
                                    ]
                                },
                                {
                                    label: "Sigma_K",
                                    step: "0.01",
                                    value: [
                                        { label: "K值下限", value: "sigmaKLower_F" },
                                        { label: "K值上限", value: "sigmaKUpper_F" },
                                    ]
                                },
                                {
                                    label: "Sigma_DCR(mΩ)",
                                    step: "1",
                                    value: [
                                        { label: "DCR下限(mΩ)", value: "sigmaDcrLower_F" },
                                        { label: "DCR上限(mΩ)", value: "sigmaDcrUpper_F" },
                                    ]
                                }
                            ],
                        },
