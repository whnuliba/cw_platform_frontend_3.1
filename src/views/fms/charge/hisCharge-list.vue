...
import elDragDialog from "@/directive/el-drag-dialog";
  import chargeDetailsList from './components/hisCharge-details'
import Pagination from '@/components/Pagination' // Secondary package based on el-pagination
import i18n from '@/lang';
export default {
  name: 'chargeList',
  components: { Pagination,chargeDetailsList },
 directives: { waves, elDragDialog },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = { url:'/chargeresultfmshis/list',params:this.queryParams}
