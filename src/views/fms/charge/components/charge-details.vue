...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  watch:{
    chargeDetailsList:function(val){
      this.getList()
       this.selectOptions()
    }
  },
  methods: {
    ...
    getList() {
      ...
      const _data = {url:'/chargeresultdts/getchargeresultdts',params:{data:this.chargeDetailsList}}
