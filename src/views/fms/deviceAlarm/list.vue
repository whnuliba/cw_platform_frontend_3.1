  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'alarmCode', title: '报警编码', minWidth: 100, align: "center",queryType: 'input', set: true },
          { field: 'alarmType', title: '报警类型', minWidth: 100, align: "center", queryType: 'input', set: true },
          { field: 'alarmName', title: '报警名称', minWidth: 100, align: "center", queryType: 'input', set: true },
          { field: 'createTime', title: '报警时间', align: 'center', queryType: 'date' },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/DeviceAlarm/list', params: this.queryParams }    // /devicealarm/getdevicealarm
