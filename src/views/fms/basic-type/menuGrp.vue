    ...
    <div class="filter-container">
       ...
       <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%"  @row-dblclick="showDetails" >
        ...
        <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
          <template slot-scope="scope">
            <i class="el-icon-edit"  @click="edit(scope.row)"  v-ele-show="{btnCode:'add_menu_grp_info'}"></i>
            &nbsp;
            <i class="el-icon-delete"  @click="del(scope.$index,scope.row)"  v-ele-show="{btnCode:'del_menu_grp_info'}"></i>
          </template>
        </el-table-column>
      </el-table>
    ...
    data() {
      const  _initdata ={
        ...
        cols: [
                  ...
                  { field: 'groupCode', title: '组编码', align: "left",query:true,queryType:'input',editReadonly:true,set:true,require:true   },
                  { field: 'udf1', title: '英文名称' ,en_title:'EnglishName', align: "left",query:true,queryType:'input',set:true,require:true   },
                  { field: 'groupName', title: '组名称', align: "left",query:true,queryType:'input',set:true,require:true   }, 
                  { field: 'desc', title: '组描述', align: "left",query:true,queryType:'input',set:true,require:true   },    
                  { field: 'scope', title: '范围', align: "left",queryType:'select',set:true,require:true   },   
                  { field: 'status', title: '启用状态', align: "left",queryType:'select',set:true,require:true   },                                  
      ]
      }
