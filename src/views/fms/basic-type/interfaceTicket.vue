 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
                { field: 'interfaceName', title: '接口名称', minWidth: 100, align: "center",query:true,queryType:'input',set:true },
                { field: 'code', title: '设备编码', minWidth: 100, align: "center",query:true,queryType:'input',set:true  },
                { field: 'bizCode', title: '业务编码', minWidth: 100, query:true, align: "center",queryType:'input',set:true },
                { field: 'ip', title: '设备IP', minWidth: 100, align: "center" ,queryType:'input',set:true},
                { field: 'createTime', title: '创建日期', align: 'center' ,query:false,queryType:'date' },               
                { field: 'expireTime', title: '失效时间', align: 'center' ,set:true ,query:false,queryType:'datetime' },               
                { field: 'createUser', title: '创建人', align: 'center' },
                { field: 'type', title: '令牌类型', minWidth: 100, align: "center",queryType:'select',set:true },
                { field: 'ticket', title: '令牌', align: 'center',query:false,queryType:'select',set:false,filter:true},
        ]
    }
  ...
  methods: {
   ...
   //初始化表格信息
    getList() {
      ...
      const _data = {url:'/ticket/list',params:this.queryParams}  // /ticket/list
  ...
  submit(formName){
       const _data = {url:'/ticket/add',params:{
