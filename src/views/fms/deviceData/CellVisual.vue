  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'surface1', title: '正面侧面(3D)', align: 'center', width: 200 },
          { field: 'surface2', title: '正面侧面(2D)', align: 'center', width: 200 },
          { field: 'surface3', title: '正面底面棱(3D)', align: 'center', width: 200 },
          { field: 'surface4', title: '后面右侧面(3D)', align: 'center', width: 200 },
          { field: 'surface5', title: '后面右侧面(2D)', align: 'center', width: 200 },
          { field: 'surface6', title: '后面底面棱(3D)', align: 'center', width: 200 },
          { field: 'udf1', title: '防爆阀(2D)', align: 'center', width: 200 },
          { field: 'udf2', title: '右中间棱(3D)', align: 'center', width: 200 },
          { field: 'udf3', title: '左中间棱(3D)', align: 'center', width: 200 },
          { field: 'udf4', title: '底面(2D)', align: 'center', width: 200 },
          { field: 'udf5', title: '底面(3D)', align: 'center', width: 200 },
          { field: 'udf6', title: '极柱面(2D)', align: 'center', width: 200 },
          { field: 'udf7', title: '极柱面(3D)', align: 'center', width: 200 },
          { field: 'udf8', title: '左右极柱(2D)', align: 'center', width: 200 },



          { field: 'status', title: '是否复测', align: 'center', width: 200 },
          ...
          { field: 'flowCode', title: '工序名称', align: 'center', width: 200 },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/cell_visual/list', params: this.queryParams }
