  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'selectThick1', title: '厚度1', align: 'center', width: 200 },
          { field: 'selectThick2', title: '厚度2', align: 'center', width: 200 },
          { field: 'selectWeight1', title: '重量', align: 'center', width: 200 },
          { field: 'trayNo', title: '托盘号', align: 'center', width: 200 , query: true, queryType: 'input', set: true},
          { field: 'grade', title: '等级', align: 'center', width: 200 , query: true, queryType: 'input', set: true},
          { field: 'value15', title: '等级名称', align: 'center', width: 200 , query: true, queryType: 'input', set: true},

          { field: 'value1', title: '电压', align: 'center', width: 200 },
          { field: 'value2', title: '内阻', align: 'center', width: 200 },
          { field: 'value3', title: '容量', align: 'center', width: 200 },
          { field: 'value4', title: 'K值', align: 'center', width: 200 },
          { field: 'value5', title: '容量上限', align: 'center', width: 200 },
          { field: 'value6', title: '容量下限', align: 'center', width: 200 },
          { field: 'value7', title: '厚度上限', align: 'center', width: 200 },
          { field: 'value8', title: '厚度下限', align: 'center', width: 200 },
          { field: 'value9', title: '重量上限', align: 'center', width: 200 },
          { field: 'value10', title: '重量下限', align: 'center', width: 200 },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/selectinfo/list', params: this.queryParams }
