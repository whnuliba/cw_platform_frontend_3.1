  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'lineNo', title: '线体', width: 145, align: "center", query: true, queryType: 'select', set: true },
          ...
          { field: 'cleanTemp', title: '清洗温度', align: 'center', width: 200, },
          { field: 'dryingTemp', title: '烘干温度', align: 'center', width: 200 },
          { field: 'cleanTime', title: '电芯清洗时间', align: 'center', width: 200 },
          { field: 'value13', title: '电芯干燥时间', align: 'center', width: 200 },
          { field: 'value1', title: '压力上风刀', align: 'center', width: 200 },
          { field: 'value2', title: '压力下风刀', align: 'center', width: 200 },
          { field: 'value3', title: '压力外侧风刀', align: 'center', width: 200 },
          { field: 'value4', title: '压力里侧风刀', align: 'center', width: 200 },
          { field: 'value5', title: '流量上风刀', align: 'center', width: 200 },
          { field: 'value6', title: '流量下风刀', align: 'center', width: 200 },
          { field: 'value7', title: '流量外侧风刀', align: 'center', width: 200 },
          { field: 'value8', title: '流量里侧风刀', align: 'center', width: 200 },
          { field: 'value9', title: '温度上风刀', align: 'center', width: 200 },
          { field: 'value10', title: '温度下风刀', align: 'center', width: 200 },
          { field: 'value11', title: '温度外侧风刀', align: 'center', width: 200 },
          { field: 'value12', title: '温度里侧风刀', align: 'center', width: 200 },
          { field: 'value14', title: '清洗通道', align: 'center', width: 200 },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/cellclean/guest/getcellclean', params: this.queryParams }
