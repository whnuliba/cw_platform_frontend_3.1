  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'PPSV', title: '正极极柱与壳体电压', width: 200, align: 'center' },
          { field: 'NPCV', title: '负极极柱与盖板电压', width: 200, align: 'center' },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/CwOcv4Controller/list', params: this.queryParams }  //  /ocv4/getocv4
      ...
      getList() {
        this.listLoading = true
        Object.assign(this.queryParams, this.listQuery)
        const _data = { url: '/CwOcv4Controller/list', params: this.queryParams }  // /ocv3/getocv3
        this.$store.dispatch('fmsCommon/actionFmsPost', _data)
          .then(data => {
            this.list = data.data
            this.total = data.total
