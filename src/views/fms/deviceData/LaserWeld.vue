  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          //{ field: 'laserPower', title: '激光预焊功率', align: 'center', width: 200 },
          //{ field: 'protectPress', title: '保护气压', align: 'center' },

          //{ field: 'topCover', title: '顶盖条码', align: 'center', width: 200 },
          //{ field: 'jigName', title: '设备夹具', align: 'center', width: 200 },

          { field: 'offsetTop', title: '上钉偏移量', align: 'center', width: 200 },

          { field: 'protFlow', title: '保护气流量', align: 'center', width: 200 },
          { field: 'tecStrength', title: '拉爆耐压强度', align: 'center', width: 200 },

          { field: 'maxWidth', title: '最大熔宽', align: 'center', width: 200 },

          { field: 'weldStation', title: '焊接工位', align: 'center', width: 200 },
          { field: 'bnNo', title: '材料 B/N', align: 'center', width: 200 },
          { field: 'result', title: '参数判定结果', align: 'center', width: 200 },
          { field: 'jigName', title: '设备夹具', align: 'center', width: 200 },
          { field: 'cleanCcdResult', title: '清洗CCD检测结果', align: 'center', width: 200 },
          { field: 'nailResult', title: '上钉CCD检测结果', align: 'center', width: 200 },
          { field: 'weldCcdResult', title: '焊接CCD检测结果', align: 'center', width: 200 },
          { field: 'weldCheck', title: '焊后CCD检测结果', align: 'center', width: 200 },
          { field: 'washTime', title: '清洗次数', align: 'center', width: 200 },
          { field: 'laserDefocus', title: '激光清洗离焦量', align: 'center', width: 200 },
          { field: 'lcFrequency', title: '激光清洗功率', align: 'center', width: 200 },
          { field: 'effectivePenetration', title: '激光清洗频率', align: 'center', width: 200 },
          { field: 'lcSpeed', title: '激光清洗速度', align: 'center', width: 200 },
          { field: 'laserZAway', title: '激光清洗脉宽', align: 'center', width: 200 },
          { field: 'peakPower', title: '预焊焊接峰值功率', align: 'center', width: 200 },
          { field: 'maxPenetration', title: '预焊焊接能量', align: 'center' },
          { field: 'frequency', title: '预焊焊接频率', align: 'center', width: 200 },
          { field: 'pulseWidth', title: '预焊焊接脉宽', align: 'center', width: 200 },
          { field: 'weldSpeed', title: '预焊焊接速度', align: 'center', width: 200 },
          { field: 'laserFullPower', title: '满焊焊接峰值功率', align: 'center', width: 200 },
          { field: 'laserDefocusAmount', title: '满焊焊接能量', align: 'center', width: 200 },
          { field: 'dustWindSpeed', title: '满焊焊接频率', align: 'center', width: 200 },
          { field: 'laserFullPulseWidth', title: '满焊焊接脉宽', align: 'center', width: 200 },
          { field: 'laserFullSpeed', title: '满焊焊接速度', align: 'center', width: 200 },
          { field: 'defocus', title: '焊接离焦量', align: 'center', width: 200 },
          { field: 'weldOffset', title: '补偿前预焊位', align: 'center', width: 200 },
          { field: 'laserProtFlow', title: '激光预焊保护气流量', align: 'center', width: 200 },
          ...
          { field: 'flowVersion', title: '流程版本', align: 'center', width: 200 },
          { field: 'processCode', title: '工序名称', align: 'center', width: 200 },  //需要的话调用一下processInfo转化为名称
          ...
          //新增字段
          { field: 'upperNailCcdCompensationValueX', title: '上钉CCD补偿值X', align: 'center', width: 200 },
          { field: 'upperNailCcdCompensationValueY', title: '上钉CCD补偿值Y', align: 'center', width: 200 },
          { field: 'preweldCcdCompensationValueX', title: '预焊CCD补偿值X', align: 'center', width: 200 },
          { field: 'preweldCcdCompensationValueY', title: '预焊CCD补偿值Y', align: 'center', width: 200 },
          { field: 'fullWeldCcdCompensationValueX', title: '满焊CCD补偿值X', align: 'center', width: 200 },
          { field: 'fullWeldNailCcdCompensationValueY', title: '满焊CCD补偿值Y', align: 'center', width: 200 },
          { field: 'upperNailedModuleConcentricity', title: '上钉模组同心度', align: 'center', width: 200 },
          { field: 'weldModuleConcentricity1', title: '焊接1模组同心度', align: 'center', width: 200 },
          { field: 'weldModuleConcentricity2', title: '焊接2模组同心度', align: 'center', width: 200 },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/CwLaserWeldController/list', params: this.queryParams }
