  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'lotNo', title: '电芯批次', minWidth: 150, align: "center", query: true,queryType: 'input', set: true },
          { field: 'lineId', title: '线体', width: 145, align: "center", query: true, queryType: 'select', set: true },
          { field: 'cellType', title: '电芯型号', width: 200, align: "center", query: true, queryType: 'input', set: true },
          { field: 'trayCode', title: '托盘条码', align: 'center', width: 200 },
          ...
          { field: 'OCV', title: '电压', align: 'center', width: 200 },
          { field: 'testCurrent', title: '电流', align: 'center', width: 200 },
          { field: 'IMP', title: '内阻', align: 'center', width: 200 },
          { field: 'testTime', title: '测试时间', align: 'center', width: 200 },
          { field: 'DCIRValue', title: 'DCIR值', align: 'center', width: 200 },

          { field: 'value1', title: '流程开始电压', align: 'center', width: 200 },
          { field: 'value2', title: '流程结束电压', align: 'center', width: 200 },
          { field: 'value3', title: '放电结束电压', align: 'center', width: 200 },
          { field: 'value4', title: '开始温度', align: 'center', width: 200 },
          { field: 'value5', title: '结束温度', align: 'center', width: 200 },
          { field: 'value7', title: 'DCIR 上限', align: 'center', width: 200 },
          { field: 'value8', title: 'DCIR 下限', align: 'center', width: 200 },
          { field: 'value9', title: 'DCIR 电压上限', align: 'center', width: 200 },
          { field: 'value10', title: 'DCIR 电压下限', align: 'center', width: 200 },


          { field: 'flowCode', title: '测试流程', align: 'center', width: 200 },
          ...
          { field: 'workShift', title: '车间班次', align: 'center', width: 200 },
          { field: 'workPeople', title: '作业人员', align: 'center', width: 200 },
          { field: 'deviceNo', title: '设备编码', align: 'center', width: 200 },
          { field: 'deviceCode', title: '设备号', align: 'center', width: 200 },
          { field: 'pltId', title: '托盘ID', align: 'center', hide: true },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/dcir/getdcir', params: this.queryParams }
