  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          { field: 'trayCode', title: '托盘条码', align: 'center', width: 200, query: true, queryType: 'input', set: true },
          ...
          { field: 'pltId', title: '壳压', align: 'center', width: 200 },
          { field: 'IMP', title: '内阻', align: 'center', width: 200 },
          { field: 'K1', title: 'K值', align: 'center', width: 200 },

          { field: 'value1', title: '电压上限', align: 'center', width: 200 },
          { field: 'value2', title: '电压下限', align: 'center', width: 200 },
          { field: 'value3', title: '壳压上限', align: 'center', width: 200 },
          { field: 'value4', title: '壳压下限', align: 'center', width: 200 },
          { field: 'value5', title: '电阻上限', align: 'center', width: 200 },
          { field: 'value6', title: '电阻下限', align: 'center', width: 200 },
          { field: 'value7', title: 'K值上限', align: 'center', width: 200 },
          { field: 'value8', title: 'K值下限', align: 'center', width: 200 },
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/CwOcv2Controller/list', params: this.queryParams }  // /ocv2/getocv2
      ...
      selectOptions() {
        ...
        _data = { url: '/CwLineInfoController/guest/all', params: {} }    // /line/guest/all
        this.$store.dispatch('fmsCommon/actionFmsPost', _data)
          .then(data => {
