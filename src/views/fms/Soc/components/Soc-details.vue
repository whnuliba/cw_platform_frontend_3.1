...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  created() {
    ...
    watch: {
      supEleDetailsList: function (val) {
        this.getList()
        this.selectOptions()
      }
    },
  methods: {
    ...
    getList() {
      ...
      const _data = { url: '/socresultdts/getsocresultdts', params: { data: this.supEleDetailsList}}
