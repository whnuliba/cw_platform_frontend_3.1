<template>
  <div class="app-container">
    ...
    <!--显示明细-->
    <el-dialog :title="'['+cellBarCode+']明细'" v-el-drag-dialog :visible.sync="supEleDetailsVisible">
      <component :is="dtsOfswitch" ref="supEleDetailsList" :supEleDetailsList="supEleDetailsList"> </component>
      <div slot="footer" class="dialog-footer">
        <el-button @click="supEleDetailsVisible = false">  {{ $t("common.btn.cancel") }}</el-button>
      </div>
    </el-dialog>
  </div>
...
import elDragDialog from "@/directive/el-drag-dialog";
  import supEleDetailsList from './components/Soc-details'
import Pagination from '@/components/Pagination' // Secondary package based on el-pagination
import i18n from '@/lang';
export default {
  name: 'suqEleList',
    components: { Pagination, supEleDetailsList },
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      supEleDetailsList:'',
      supEleDetailsVisible:false,
      cellBarCode:'',
      dtsOfswitch:'supEleDetailsList',
      queryParams:{
        requestData:{ }
        },
      initSelect:{
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = { url:'/CwSocResultController/list',params:this.queryParams}  // /socresult/getsocresult
    ...
    //   })
      ...
      this.cellBarCode = row.cellBarCode
        this.supEleDetailsList=row.id
        this.supEleDetailsVisible=true
