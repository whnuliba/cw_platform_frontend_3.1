...
<script>
  ...
  import pointForDetailsList from './components/pointsFor-details'
  ...
  export default {
    name: 'pointForList',
    components: {Pagination, pointForDetailsList, ColTableInit},
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          ...
          {field: 'unit', title: '拟合容量', minWidth: 150, align: 'right'},
          {field: 'actId', title: '横流比', minWidth: 150, align: 'right'},
          {field: 'trayCode', title: '首次效率', minWidth: 150, align: 'right'},
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = {url: '/CwPointsForResultController/list', params: this.queryParams}  // /pointsforresult/getpointsforresult
