<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-dblclick="showDetails" height="400">
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
            { field: 'hedId', title: 'hedId',hide:true, align: 'center' },
            { field: 'flowCode', title: '流程', minWidth: 100, align: "center" },
            { field: 'startTime', title: '开始时间', align: 'center' ,width:200},
            { field: 'stopTime', title: '结束时间', align: 'center' ,width:200},
            { field: 'startCapacity', title: '开始容量', align: 'center' },
            { field: 'stopCapacity', title: '结束容量', align: 'center' },
            { field: 'startVoltage', title: '开始电压', align: 'center' },
            { field: 'stopVoltage', title: '结束电压', align: 'center' },
            { field: 'startCurrent', title: '开始电流', align: 'center' },
            { field: 'stopCurrent', title: '结束电流', align: 'center' },
            { field: 'startEnergy', title: '开始能量', align: 'center' },
            { field: 'stopEnergy', title: '结束能量', align: 'center' },
            { field: 'temperature', title: '温度', align: 'center' },
            { field: 'sequence', title: '序列', align: 'center' },
            { field: 'vacuum', title: '真空度', align: 'center' },
    ]
    }
  ...
  created() {
    ...
    watch: {
      pointForDetailsList: function (val) {
        this.getList()
        this.selectOptions()
      }
    },
  methods: {
    ...
    getList() {
      ...
      const _data = { url: '/pointsforresultdts/getpointsforresultdts', params: { data: this.pointForDetailsList}}
