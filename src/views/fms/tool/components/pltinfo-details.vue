...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [
        ...
        { field: 'channel', title: '通道', width: 60, align: "center" },
        { field: 'processName', title: '当前工序', minWidth: 100, align: "center" },
        { field: 'cellState', title: '状态', minWidth: 100, align: "center"},
        { field: 'processCode', title: '当前工序', hide: true, minWidth: 100, align: "center" },
    ]
    }
  ...
  created() {
    ...
    watch: {
      pltinfoDetailsList: function (val) {
        this.getList()
        this.selectOptions()
      }
    },
  methods: {
    ...
    getList() {
      ...
      const _data = { url: '/cell/guest/get-cell-tray_no', params: { data: this.pltinfoDetailsList}}
