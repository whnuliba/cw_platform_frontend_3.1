  ...
  export default {
    ...
    data() {
      const _initdata = {
        ...
        cols: [
          { field: 'orgName', title: '组织名称', minWidth: 100, align: "center", query: true, queryType: 'input', set: true },
          { field: 'orgCode', title: '组织编码', minWidth: 100, align: "center",queryType: 'input', set: true , query: true},    
        ]
      }
    ...
    methods: {
      ...
      getList() {
        ...
        const _data = { url: '/org/list', params: this.queryParams }
      ...
      save(formName) {
        ...
        let _data = { url: '/org/add', params: { data: {...this.defaultForm.params,status:1,grade:0} } }
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$store.dispatch('fmsCommon/actionAuthPost', _data)
              .then(data => {
