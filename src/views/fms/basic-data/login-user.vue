<template>
  <div class="app-container">
     ...
     <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%"  @row-dblclick="showDetails" >
      ...
      <el-table-column min-width="50px" width="60px" label="序号" align="center">
      ...
      <el-table-column align="center" label="操作" fixed="right" width="200">
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="small" icon="el-icon-edit" @click="kickedOut(scope.$index,scope.row)">
              {{ $t("common.btn.kickedOut") }}
          </el-button>
 ...
 directives: { waves, elDragDialog },
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = {url:'/user/login-user',params:this.queryParams}
  ...
  query(){
   ...
   kickedOut(index,row){
      ...
      this.$confirm(i18n.t("common.tip_info.kickedOut"), i18n.t("common.tip_info.tips"), {
          ...
          type: 'warning'
              ...
              let userDto = {
                ...
                const _data = {url:'/user/kicked-out',params:{data:userDto}}
                this.$store.dispatch('fmsCommon/actionAuthPost',_data)
                .then(data => {
