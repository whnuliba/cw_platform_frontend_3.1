<template>
  <div class="app-container role-factory">
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          ...
          del:"/base-factory/del",
          list:"/base-factory/guest/items"
      },
      queryParams:{
        requestData:{ }
        },
      ...
      cols: [
                ...
                { field: 'factoryNo', title: '工厂编码', align: "left",query:true,queryType:'input',set:true,require:true   },
                { field: 'factoryDesc', title: '工厂描述', align: "left",query:true,queryType:'input',set:true,require:true   },               
                { field: 'remark', title: '备注', align: "left",query:true,queryType:'input',set:true,require:false   },  
