<template>
  <div class="app-container">
    ...
    <el-table v-loading="dtlLoading" :data="dtlTableList" border fit highlight-current-row style="width: 100%" @row-dblclick="showDetails" height="400">
...
export default {
 ...
 directives: { waves, elDragDialog },
  filters: {
    ...
    props: ['dtlTableList','dtlLoading'],  //'flowDetailsList', 
  data() {
    const  _initdata ={
      ...
      cols: [
        ...
        { field: 'processCode', title: '工序编码', align: 'center' },
        { field: 'processNameType', title: '工序名称', minWidth: 150, align: 'center' },
        { field: 'inStation', title: '入站时间', minWidth: 150, align: 'center' },
        { field: 'outStation', title: '出站时间', minWidth: 150, align: 'center' },
        { field: 'cellState', title: '电芯状态', align: 'center' },
        { field: 'workShift', title: '班次', minWidth: 150, align: 'center' },
        { field: 'workPeople', title: '备注(NG原因)', minWidth: 150, align: 'center' },
        { field: 'deviceNo', title: '设备编码', align: 'center' },
        { field: 'totalCapacity', title: '容量', minWidth: 150, align: 'center' },
        { field: 'endVoltage', title: '结束电压', minWidth: 150, align: 'center' },
        { field: 'ocv', title: 'ocv', minWidth: 150, align: 'center' },
        { field: 'imp', title: 'imp', minWidth: 150, align: 'center' },
        { field: 'dcirvalue', title: 'DCIR值', minWidth: 150, align: 'center' },
        { field: 'rackHeRate', title: '注液量', minWidth: 100, align: 'center' },
    ]
    }
  ...
  methods: {
    ...
    //   const _data = { url: '/cell/guest/getcells_process_flows_by_code', params: { data: this.flowDetailsList}}
  ...
  query(){
   ...
   selectOptions(){
     var _data = { url: '/constant/cell-state', params: {} }
     this.$store.dispatch('fmsCommon/actionFmsPost', _data)
       .then(data => {
