 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [       
            { field: 'orderNo', title: '内部单号',en_title:"PN",  align: "center",width:120,query:true,queryType:'input',editReadonly:false,set:false,require:true, width:130 }, 
            ...
            { field: 'extOrderNo', title: '外部单号', align: "left",query:true,queryType:'input',set:true,require:true, width:130},              
            { field: 'erpOrderNo', title: 'ERP单号', align: "left",query:false,queryType:'input',set:true,require:true, width:130},
  ...
  methods: {
    ...
    getList() {
      ...
      const _data = {url:this.url.list,params:{data:this.poId}}
