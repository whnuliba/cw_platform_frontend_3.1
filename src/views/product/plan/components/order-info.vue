 ...
 directives: { waves, elDragDialog },
  ...
  data() {
    const  _initdata ={
      ...
      cols: [     
            { field: 'orderNo', title: '内部单号',en_title:"PN",  align: "left",query:true,queryType:'input',editReadonly:false,set:false,require:true, width:130 },                 
            { field: 'pn', title: '产品编码', align: "left",query:true,queryType:'input',set:true,require:true, width:130},
            // { field: 'gn', title: '图号',query:true,align: "left",queryType:'input',set:true,require:true  },
            { field: 'projectNo', title: '费用号', align: "left",query:true,queryType:'input',set:true,require:true,width:130},
            { field: 'createTime', title: '创建日期', align: "left",query:false,queryType:'input',set:false,require:true, width:150},
            { field: 'createUser', title: '创建人', align: "left",query:false,queryType:'input',set:false,require:true, width:100   },
            { field: 'priority', title: '优先级', align: "left",query:true,queryType:'select',set:true,require:true   },
            { field: 'erpOrderNo', title: 'ERP单号', align: "left",query:true,queryType:'input',set:true,require:true,width:130},
            { field: 'endTime', title: '最晚交货', align: "left",query:false,queryType:'datetime',set:true,require:true, width:150},
            { field: 'lotNo', title: '批次', align: "left",query:false,queryType:'input',set:true,require:true, width:120},
            ...
            { field: 'wsNo', title: '车间',query:true,align: "left",queryType:'select',set:true,require:true, width:120  },
