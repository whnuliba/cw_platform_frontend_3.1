  ...
  <div >
     <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%"  @row-dblclick="showDetails" >
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
        <template slot-scope="scope">
          <!-- <i class="el-icon-edit" v-if="scope.row.status==106"  @click="edit(scope.row)"></i>
          &nbsp; -->
  ...
  data() {
    const  _initdata ={
      ...
      url:{
          ...
          list:"/section-order/guest/order-material"
      },
      defaultForm: {
        row:{},
        params:{
      ...
      cols: [       
            { field: 'erpOrderNo', title: 'ERP订单',en_title:"PN",  align: "center",width:120,query:true,queryType:'input',editReadonly:false,set:false,require:true },
            { field: 'wsNo', title: '工厂工段', align: "left",query:false,queryType:'input',set:true,require:true   }, 
            ...
            { field: 'workNo', title: '生产工单', align: "left",query:false,queryType:'input',set:true,require:true   },
            { field: 'extOrderNo', title: '计划号', align: "left",query:true,queryType:'input',set:true,require:true   },
            { field: 'orderNo', title: '产线工单', align: "left",query:false,queryType:'input',set:false,require:true   },
            { field: 'routeNo', title: '工艺路线', align: "left",query:false,queryType:'input',set:false,require:true   },           
            { field: 'pn', title: '物料编码', align: "left",query:true,queryType:'input',set:true,require:true   },
            { field: 'pnName', title: '物料名称',query:true,align: "left",queryType:'input',set:true,require:true  },              
            { field: 'gn', title: '物料图号',query:true,align: "left",queryType:'input',set:true,require:true  },                         
            { field: 'processNo', title: '工序',query:true,align: "left",queryType:'input',set:true,require:true  },              
            { field: 'stationNo', title: '工位',query:true,align: "left",queryType:'input',set:true,require:true  },              
            { field: 'qty', title: '物料需求', align: "left",query:false,queryType:'input',set:true,require:true   },
