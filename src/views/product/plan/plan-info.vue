<template>
  ...
  <div class="filter-container">
     ...
     <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-click="bomItemRowClick"  @row-dblclick="showDetails" >
  ...
  data() {
    const  _initdata ={
      ...
      cols: [    
                ...
                { field: 'qty', title: '排产数量', align: "left",query:true,queryType:'input',set:true,require:true,editReadonly:true   },
                { field: 'createTime', title: '创建日期', align: "left",query:true,queryType:'input',set:false,require:true   },
                { field: 'createUser', title: '创建人', align: "left",query:true,queryType:'input',set:false,require:true   },
                { field: 'planStartTime', title: '计划开始时间',en_title:"PN",  align: "left",query:true,queryType:'datetime',set:true,require:true },               
                { field: 'planEndTime', title: '计划结束时间', align: "left",query:true,queryType:'datetime',set:true,require:true   },
                { field: 'actualStartTime', title: '实际开始时间',hide:true,en_title:"PN",  align: "left",query:true,queryType:'datetime',editReadonly:false,set:false,require:true },               
                { field: 'actualEndTime', title: '实际结束时间',hide:true, align: "left",query:true,queryType:'datetime',set:false,require:true   },
