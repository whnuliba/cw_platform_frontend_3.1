...
export default {
  ...
  data() {
    const _initdata = {
      ...
      inoutStationId: '',
      url: {
        add: '/productDriverProcessMaterial/add',
        del: '/productDriverProcessMaterial/del',
        list: '/productDriverProcessMaterial/guest/selectByItemId'
      },
      queryParams: {
        requestData: { }
      },
