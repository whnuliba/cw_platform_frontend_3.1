  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @row-dblclick="showDetails">
      ...
      <el-table-column align="left" :label="$t('common.oper')" fixed="right" width="80">
        ...
        <template slot-scope="scope">
          <i v-ele-show="{btnCode:'ModelBringForth_add'}" class="el-icon-edit" @click="edit(scope.row)" />
          &nbsp;
          <i v-ele-show="{btnCode:'ModelBringForth_del1'}" class="el-icon-delete" @click="del(scope.$index,scope.row)" />
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  props: {
    // 外部传入的内容，用于实现双向绑定
    value: String,
    modelBringForthId: String
  },
  data() {
    const _initdata = {
      table_mark: 'pp_mbf_list',
      dialogFormVisible: false,
      allowDisable: false,
      dialogSelectFieldVisible: false,
      url: {
        add: '/productModelBringForth/add',
        del: '/productModelBringForth/del',
        list: '/productModelBringForth/list'
      },
      queryParams: {
        requestData: { }
      },
      ...
      cols: [
        { field: 'toolNo', title: '模具编码', align: 'left', query: true, queryType: 'input', set: true, require: true },
        { field: 'toolName', title: '模具名称', align: 'left', query: true, queryType: 'input', set: true, require: true },
        { field: 'deviceNo', title: '使用设备编码', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'deviceName', title: '使用设备名称', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'qty', title: '领出数量', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'forthTime', title: '领出时间', align: 'left', width: '145px', query: false, queryType: 'date', set: true, require: false },
        { field: 'forthUser', title: '领出人', align: 'left', query: false, queryType: 'input', set: true, require: false },
        { field: 'stationNo', title: '领出工位', align: 'center', queryType: 'input', set: true, require: false },
        { field: 'processNo', title: '领出工序', align: 'center', queryType: 'input', set: true, require: false },
        { field: 'retTime', title: '计划归还日期', align: 'center', width: '145px', queryType: 'date', set: true, require: false },
        { field: 'useQty', title: '使用次数', align: 'center', queryType: 'input', set: true, require: false },
        { field: 'isRet', title: '是否剩余规划', align: 'center', queryType: 'input', set: true, require: false },
