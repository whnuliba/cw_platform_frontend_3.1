      ...
      <el-tab-pane label="物料归档">
          <el-form ref="form1" :model="end" label-width="35%">
            <el-form-item label="产线编号:">
              <el-input v-model="archiving.deviceNo" placeholder="产线编号" style="width: 150px"   class="filter-item"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  methods: {
    ...
    selectOptions() {
      const _data = {url:'/winding/selectWorkshopBySysParam'}
    ...
    endsubmit(){
      const _data = {url:'/winding/pdaCompleteProduct',params:this.end}
      this.$store.dispatch('fmsCommon/actionProductPost',_data)
        .then(data => {
          this.$message({
            type: 'success',
    ...
    submit(){
      const _data = {url:'/winding/startProduct',params:this.barcode}
      this.$store.dispatch('fmsCommon/actionProductPost',_data)
        .then(data => {
          this.$message({
            type: 'success',
