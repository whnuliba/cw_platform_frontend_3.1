  ...
  <div class="filter-container" style="width:100%">
    <el-tabs>
      ...
      <el-form-item label="工作中心:">
        <el-select @change="workshopNochange" v-model="barcode.workshopNo" placeholder="请选择" style="width: 160px"   class="filter-item" >
        <el-option
      ...
      <el-form-item label="工单:">
            <el-select v-model="barcode.orderNo" placeholder="请选择" style="width: 160px"   class="filter-item" >
            <el-option
      ...
      <el-form-item label="锅次编码:">
        <el-input v-model="barcode.panTime" placeholder="锅次编码" style="width: 160px"   class="filter-item"></el-input>
      </el-form-item>
      <el-form-item label="大卷号:">
        <el-input type="number" v-model="barcode.mwindNo" placeholder="大卷号" style="width: 160px"   class="filter-item"></el-input>
      </el-form-item>
      ...
      <el-tab-pane label="物料归档">
          <el-form ref="form1" :model="end" label-width="35%">
            <el-form-item label="设备编码:">
              <el-input v-model="archiving.deviceNo" placeholder="设备编码" style="width: 150px"   class="filter-item"></el-input>
            </el-form-item>
            <el-form-item>
            <el-button type="warning" class="filter-item" @click="aterialarchiving">
              {{ '物料归档' }}
            </el-button>
          </el-form-item>
          </el-form>
...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  methods: {
    ...
    endsubmit(){
      const _data = {url:'/coating/pdaCompleteProduct',params:this.end}
      this.$store.dispatch('fmsCommon/actionProductPost',_data)
        .then(data => {
          this.$message({
            type: 'success',
    ...
    submit(){
         const _data = {url:'/coating/startProduct',params:this.barcode}
        this.$store.dispatch('fmsCommon/actionProductPost',_data)
          .then(data => {
            this.$message({
              type: 'success',
    ...
    submintsubsection(){
      this.$confirm("确认分卷吗?", "提示", {
        ...
        type: "warning",
         ...
         const _data = {url:'/coating/subsection',params:{data:this.subsection}}
        this.$store.dispatch('fmsCommon/actionProductPost',_data)
          .then(data => {
            this.$message({
              type: 'success',
    ...
    aterialarchiving(){
         const _data = {url:'/lineProcessPack/barcodeComplete',params:{data:this.archiving}}
        this.$store.dispatch('fmsCommon/actionProductPost',_data)
          .then(data => {
            this.$message({
              type: 'success',
