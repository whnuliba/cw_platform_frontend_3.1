<template>
  ...
  <div class="filter-container">
           ...
           <div>
            <el-input   v-model="barcode.sn" placeholder="产品条码" style="width: 150px"   class="filter-item"></el-input>
           </div>
           <div>
            <el-input   v-model="barcode.ioFlag" placeholder="出入站" style="width: 150px"  class="filter-item"></el-input>
           </div>
           <div>
 ...
 directives: { waves, elDragDialog },
  ...
  submit(){
       const _data = {url:'/bus/api/guest/result',params:{
          data:this.barcode,  resourceNo:"BARCODE_INOUT_SERVICE"
       }}
