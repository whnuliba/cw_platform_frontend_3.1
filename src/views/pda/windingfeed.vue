  ...
  <div class="filter-container">
    <el-form ref="form" :model="barcode" label-width="80px">
      <el-form-item label="物料类型:">
        <el-select v-model="barcode.windingFeedType" placeholder="请选择" style="width: 150px"   class="filter-item" >
        <el-option
...
export default {
  ...
  methods: {
    ...
    submit() {
      let obj = {
        windingFeedType:this.barcode.windingFeedType,
      ...
      const _data = {
        url: "/windingSvolume/windingFeeding",
        params: obj,
      };
      this.$store
