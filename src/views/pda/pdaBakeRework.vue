      ...
      <el-tab-pane label="开始生产">
        <el-form ref="form" :model="barcode" label-width="35%">
          ...
          <el-form-item label="人员:">
            <el-input disabled v-model="barcode.person" placeholder="人员" style="width: 150px"   class="filter-item"></el-input>
          </el-form-item>
          <el-form-item label="班次:">
            <el-input v-model="barcode.workShfit" placeholder="班次" style="width: 150px"   class="filter-item"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-tab-pane label="完成生产">
          <el-form ref="form1" :model="end" label-width="35%">
            ...
            <el-form-item label="卷号:">
              <el-input v-model="end.mwindNo" placeholder="卷号" style="width: 150px"   class="filter-item"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
 ...
 directives: { waves, elDragDialog },
  ...
  methods: {
     ...
     endsubmit(){
      const _data = {url:'/bake/bakeReworkComplete',params:{data:this.end}}
    ...
    submit(){
      const _data = {url:'/bake/bakeRework',params:{data:this.barcode}}
      this.$store.dispatch('fmsCommon/actionProductPost',_data)
        .then(data => {
          this.$message({
            type: 'success',
