{
  ...
  url:{
       deleteUri:'/cw-wms-app/cw-wms-stereoscopic/deleteById',
       editUri:'/cw-wms-app/cw-wms-stereoscopic/updateById',
       addUri:'/cw-wms-app/cw-wms-stereoscopic/createBaseComponent',
       queryUri:'/cw-wms-app/cw-wms-stereoscopic/queryPage',
       batchAddUri:'/cw-wms-app/cw-wms-stereoscopic/batchCreateBaseComponent',
       fileUpload:'/cw-wms-app/cw-wms-stereoscopic/uploadFile',
       fileDownload:'/cw-wms-app/cw-wms-stereoscopic/downloadFile',
       removeFile:'/cw-wms-app/cw-wms-stereoscopic/removeFile',
       query:'/cw-wms-app/cw-wms-stereoscopic/query',
  ...
  customToolBar:{
    ...
    buttons:[
      ...
      {text:'单条创建',icon:'el-icon-plus',permCode:'MF_WMS002647',background:'',size:'mini',hideText:false,callback:function(e,self){
        self.add()
      }},
      {text:'编辑',icon:'el-icon-edit',permCode:'MF_WMS002646',background:'',size:'mini',hideText:false,callback:function(e,self){
        self.edit(self.boxSelectValue[0])
      }},
      {text:'删除',icon:'el-icon-delete',permCode:'MF_WMS002645',background:'',size:'mini',hideText:false,callback:function(e,self){
        self.handleDelete(self.boxSelectValue[0])
      }},
	  {text:'批量创建',icon:'el-icon-edit',permCode:'MF_WMS002649',background:'',size:'mini',hideText:false,callback:function(e,self){
          this.formDialogVisibles['stereoscopicDialog']=true
      }}
    ]
  },
  formModes:[{
	   title: '批量创建',
       dialogVisible:'stereoscopicDialog',
       dialogShow:false,
       cancelBtnShow:true,
	   forms:[
	    ...
	    buttons:[
            {text:'确认',hideText:false,icon:'el-icon-success',permCode:undefined,background:'',size:'max',callback:function(e,row,form){
				  ...
				  let op = {url:this.tableInfo.tableCtrlScript.url.batchAddUri,params:{data:{data:locFormArr }}}
					 ...
					 this.formDialogVisibles['stereoscopicDialog']=false
                 })
			},
			style:{
  ...
  cols: [
        ...
        {"hide":true,"set":true,"field":"LOCATION_CODE","query":false,"width":150,"require":false,"title":"位置编码","align":"center","queryType":"input"},
        {"hide":true,"set":true,"field":"LOCATION_GROUP","query":false,"width":150,"require":false,"title":"组编码","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"X_AXIS","query":false,"width":150,"require":false,"title":"排","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"Y_AXIS","query":false,"width":150,"require":false,"title":"列","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"Z_AXIS","query":false,"width":150,"require":false,"title":"层","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"COMMAND_CODE","query":false,"width":150,"require":false,"title":"通讯码","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"RELAX_FORK","query":false,"width":150,"require":false,"title":"关联货叉","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"DEEP","query":false,"width":150,"require":false,"title":"深度","align":"center","queryType":"input"},
        {"hide":false,"set":true,"field":"RACK_CODE","query":false,"width":150,"require":false,"title":"货架号","align":"center","queryType":"input"},
