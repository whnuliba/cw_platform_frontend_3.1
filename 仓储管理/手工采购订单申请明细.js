{
  ...
  customToolBar:{
    ...
    buttons:[
      {text:'增加',icon:'el-icon-plus',permCode:'MF_WMS002839',background:'',size:'mini',hideText:false,callback:function(e,self){
		 if(this.cols){
			 let row = {}
      ...
      {text:'删除',icon:'el-icon-delete',permCode:'MF_WMS002837',background:'',size:'mini',hideText:false,callback:function(e,self){
	  ...
	  {text:'保存',icon:'el-icon-document-checked',permCode:'MF_WMS002803',background:'',size:'mini',hideText:false,callback:function(e,self){
