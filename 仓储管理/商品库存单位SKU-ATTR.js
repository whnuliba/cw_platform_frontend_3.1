{
  ...
  customToolBar:{
    ...
    buttons:[
      ...
      {text:'增加' ,show:true,key:'add',icon:'el-icon-plus',permCode:'MF_WMS003019',background:'',size:'mini',hideText:false,callback:function(e,self){
        self.add()
      }},
      {text:'编辑',show:true,key:'edit',icon:'el-icon-edit',permCode:'MF_WMS003018',background:'',size:'mini',hideText:false,callback:function(e,self){
        self.edit(self.boxSelectValue[0])
      }},
      {text:'删除' ,show:true,key:'delete',icon:'el-icon-delete',permCode:'MF_WMS003017',background:'',size:'mini',hideText:false,callback:function(e,self){
